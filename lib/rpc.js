...
export function registerUsageRpc(ctx, dispatcher) {
	// Hosts <= 0.1.1-rc.x require the per-channel `authority` loopback fence.
	// Hosts >= 0.1.2-alpha.1 ignore it and authenticate every route at the
	// transport layer (signed browser cookie + launch token + loopback fence).
