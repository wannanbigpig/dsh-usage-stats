...
import { providerStatusFromHttp } from "./provider-status.js";

/** Compatibility re-export; the mapping now lives in `./provider-status.js`. */
export const responseStatus = providerStatusFromHttp;
