...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".usg_rightbarBody .usg_overviewWorkbench{grid-template-columns:minmax(0,1fr) minmax(264px,32%);grid-template-areas:\"activity rail\" \"heat heat\"}",
			...
			".usg_day{width:100%;min-height:30px;align-items:center;gap:8px;border:0;background:0 0;border-bottom:0.5px solid var(--dsw-alias-border-l1);padding:5px 4px;font:inherit;text-align:left;cursor:pointer;display:flex;border-radius:6px}",
			...
			".usg_dayTrack{background:var(--dsw-alias-bg-module-platform);border-radius:3px;height:6px;flex:1;min-width:80px;overflow:hidden}",
			...
			"@container usage-pane (max-width:840px){.usg_rightbarBody .usg_overviewWorkbench{grid-template-columns:1fr;grid-template-areas:\"activity\" \"rail\" \"heat\"}.usg_rightbarBody .usg_insightRail{display:flex}.usg_rightbarBody .usg_overviewWorkbench[data-usage-summary=true] .usg_insightRail{align-self:start;overflow:visible;contain:none}.usg_rightbarBody .usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageCard{flex:none;min-height:auto;overflow:visible}.usg_rightbarBody .usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageList{flex:none;min-height:auto;overflow-y:visible;scrollbar-gutter:auto}}",
			"@media(max-width:840px){.usg_overviewWorkbench{grid-template-columns:1fr;grid-template-areas:\"activity\" \"rail\" \"heat\"}.usg_header{grid-template-columns:minmax(0,1fr) auto}.usg_headerLeft{grid-column:1;grid-row:1}.usg_header>.usg_tabs{grid-column:1/-1;grid-row:2;justify-self:start}.usg_headerActions{grid-column:2;grid-row:1}.usg_insightRail{display:flex}.usg_overviewWorkbench[data-usage-summary=true] .usg_insightRail{align-self:start;overflow:visible;contain:none}.usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageCard{flex:none;min-height:auto;overflow:visible}.usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageList{flex:none;min-height:auto;overflow-y:visible;scrollbar-gutter:auto}.usg_hourCard .usg_chartBody{height:150px}}",
