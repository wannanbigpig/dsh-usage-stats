...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"data.rebuildNote": "从官方会话持久化重建全部历史估算；由更新版本 Harness 写入、无法解读的会话会跳过并在此提示。",
			"data.rebuild": "重建估算",
		...
		const en = {
			...
			"data.rebuildNote": "Rebuild all estimated history from official session persistence; sessions written by a newer Harness build that cannot be read are skipped and reported here.",
