...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".usg_refreshButton{width:30px;height:30px;color:var(--dsw-alias-label-secondary);border:0;background:transparent;border-radius:8px}",
			".usg_refreshButton:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}",
			".usg_refreshGlyph{display:block;pointer-events:none}",
			...
			".usg_hourTooltipHead{flex-direction:column;align-items:flex-start;gap:2px;margin-bottom:3px;font-size:12px;font-weight:600;display:flex}",
					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							...
							hovered !== null && react_jsx_runtime.jsxs("div", {
								...
								children: [
									react_jsx_runtime.jsxs("div", { className: S.hourTooltipHead, children: [hovered.date, money(hovered.cost)] }),
						...
						children: [
							...
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									...
									onClick: refreshAll,
									children: react_jsx_runtime.jsxs("svg", { className: S.refreshGlyph, width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [react_jsx_runtime.jsx("path", { d: "M21 12a9 9 0 1 1-6.22-8.56", key: "path1" }), react_jsx_runtime.jsx("polyline", { points: "21 3 21 9 15 9", key: "polyline1" })] })
									}),
									react_jsx_runtime.jsx("button", {
										type: "button",
