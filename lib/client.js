 ...
 * sidebar footer action that opens the native right Sidebar or global main
 * panel, with a native Modal fallback for older hosts. The
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region css
		const css = [
			".usg_layer{flex:none;align-items:center;width:calc(100% + 4px);height:42px;margin:4px -2px 0;display:flex;position:relative}",
			".usg_footerButtons{align-items:center;width:100%;display:flex}",
			".usg_sidebarButton{width:100%;height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:8px;padding:0 10px 0 8px;font:inherit;font-size:14px;line-height:22px;display:inline-flex;overflow:hidden}",
			".usg_sidebarButton:hover{background:var(--dsw-alias-interactive-bg-hover)}",
			...
			".usg_layer.usg_rail{width:36px;height:36px;margin:4px 0 0}",
			".usg_layer.usg_rail .usg_sidebarButton{border-radius:50%;corner-shape:round;justify-content:center;gap:0;width:36px;height:36px;padding:0}",
			".usg_panel.usg_panel{box-sizing:border-box;border:0;padding:0;gap:0;background:var(--dsw-alias-bg-layer-2);width:920px;max-width:calc(100vw - 48px);max-height:94vh;box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--usg-blue:var(--dsw-alias-state-business-primary,var(--dsw-static-deepseek-500,#4176e6));--usg-green:var(--dsw-alias-state-success-primary,#23a878);--usg-cellEmpty:var(--dsw-alias-interactive-bg-hover);border-radius:24px;position:relative;overflow:hidden}",
			".usg_panelBody{box-sizing:border-box;max-height:94vh;padding:18px;overflow-y:auto}",
			".usg_panel .usg_section{max-width:none}",
			".usg_rightbarBody{box-sizing:border-box;width:100%;height:100%;padding:12px;overflow-y:auto;container-type:inline-size;container-name:usage-pane;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}",
			".usg_rightbarBody .usg_section{max-width:none}",
			".usg_rightbarBody .usg_header{top:-12px;grid-template-columns:minmax(0,1fr) auto;padding:0 0 10px;background:var(--dsw-alias-bg-base)}",
			".usg_rightbarBody .usg_headerLeft{display:none}",
			".usg_rightbarBody .usg_header>.usg_tabs{grid-column:1;grid-row:1;justify-self:start}",
			".usg_rightbarBody .usg_headerActions{grid-column:2;grid-row:1}",
			".usg_rightbarBody .usg_chartInner{min-width:0}",
			".usg_rightbarBody .usg_overviewWorkbench{grid-template-columns:minmax(0,1fr) minmax(248px,31%);grid-template-areas:\"activity rail\" \"heat heat\" \"workspace workspace\"}",
			".usg_mainBody{box-sizing:border-box;width:100%;height:100%;padding:24px;overflow-y:auto;background:var(--dsw-alias-bg-base);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}",
			".usg_mainBody .usg_section{margin:0 auto;max-width:920px}",
			".usg_mainBody .usg_header{top:-24px;padding:0 0 12px;background:var(--dsw-alias-bg-base)}",
			".usg_section{--usg-blue:var(--dsw-alias-state-business-primary,var(--dsw-static-deepseek-500,#4176e6));--usg-cellEmpty:var(--dsw-alias-interactive-bg-hover,var(--dsw-alias-bg-module-platform,rgba(128,128,128,.12)));--usg-action:var(--dsw-alias-button-primary-fill,var(--dsw-alias-brand-primary,#0f1115));--usg-action-text:var(--dsw-alias-label-primary-foreground,#fff);--usg-control-bg:var(--dsw-alias-bg-layer-1,var(--dsw-alias-bg-base,#fff));--usg-control-text:var(--dsw-alias-label-primary,#171717);--usg-control-border:var(--dsw-alias-border-l2,rgba(128,128,128,.24));--usg-control-placeholder:var(--dsw-alias-label-dimmed,rgba(128,128,128,.48));--usg-success:var(--dsw-alias-state-success-primary,#22a06b);--usg-warning:var(--dsw-alias-state-warn-primary,#d99b00);--usg-danger:var(--dsw-alias-state-error-primary,#e5484d);box-sizing:border-box;flex-direction:column;gap:14px;width:100%;max-width:920px;display:flex}",
			...
			".usg_balance{border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:20px;padding:16px;flex-direction:column;gap:12px;display:flex}",
			...
			".usg_select{box-sizing:border-box;min-width:0;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);border:0.5px solid var(--dsw-alias-border-l2);border-radius:8px;padding:0 12px;font:inherit;font-size:13px;line-height:20px;cursor:pointer}",
			".usg_statsRow{display:flex;gap:8px;flex-wrap:wrap}",
			".usg_stat{box-sizing:border-box;border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex:1;min-width:110px;flex-direction:column;gap:2px;padding:10px 11px;display:flex}",
			...
			".usg_card{border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:16px;padding:14px 16px;flex-direction:column;gap:12px;display:flex}",
			...
			".usg_overviewWorkbench{display:grid;grid-template-columns:minmax(0,1fr) 280px;grid-template-areas:\"activity rail\" \"heat heat\" \"workspace workspace\";gap:14px;align-items:start}",
			".usg_activityStage{grid-area:activity;min-width:0;border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:20px;padding:18px;display:flex;flex-direction:column;gap:16px}",
			...
			".usg_activityMeta{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform);border-radius:999px;corner-shape:round;padding:4px 10px;font-size:11px;line-height:18px;white-space:nowrap;font-variant-numeric:tabular-nums}",
			".usg_modelFilterChip{max-width:210px;height:26px;min-width:0;display:inline-flex;align-items:center;gap:5px;color:var(--usg-blue);background:color-mix(in srgb,var(--usg-blue) 8%,transparent);border:0.5px solid color-mix(in srgb,var(--usg-blue) 22%,var(--dsw-alias-border-l1));border-radius:999px;corner-shape:round;padding:0 8px;font:inherit;font-size:10px;line-height:16px;cursor:pointer}",
			".usg_modelFilterChip:hover{background:color-mix(in srgb,var(--usg-blue) 13%,transparent);border-color:color-mix(in srgb,var(--usg-blue) 38%,var(--dsw-alias-border-l1))}",
			".usg_modelFilterChip span:first-child{min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
			".usg_modelFilterClear{font-size:12px;line-height:1;opacity:.7}",
			...
			".usg_overviewWorkbench[data-usage-summary=true] .usg_insightRail{align-self:stretch;min-height:0;overflow:hidden;contain:size}",
			".usg_providerUsageCard{border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:16px;padding:13px;display:flex;flex-direction:column;gap:10px}",
			".usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageCard{flex:1;min-height:0;overflow:hidden}",
			".usg_providerUsageList{display:flex;flex-direction:column;gap:7px}",
			".usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageList{flex:1;min-height:0;overflow-y:auto;scrollbar-gutter:stable;overscroll-behavior:contain}",
			...
			".usg_modelNameCopyTip{position:fixed;z-index:1200;width:max-content;max-width:min(260px,calc(100vw - 24px));transform:translate(-50%,-100%);color:var(--dsw-alias-label-primary-inverted,#fff);background:var(--dsw-alias-button-contrast-fill,#1f2329);border:0;border-radius:8px;padding:6px 9px;box-shadow:var(--dsw-elevation-panel);font-size:11px;font-weight:400;line-height:16px;white-space:normal;overflow-wrap:anywhere;pointer-events:auto;user-select:text;cursor:text}",
			...
			".usg_providerUsageTrack{grid-area:track;height:4px;border-radius:999px;corner-shape:round;background:var(--dsw-alias-bg-module-platform);overflow:hidden}",
			".usg_providerUsageBar{display:block;height:100%;border-radius:inherit;background:var(--usg-blue);opacity:.78}",
			".usg_modelTrend{border-top:0.5px dashed var(--dsw-alias-border-l2);padding-top:13px;display:flex;flex-direction:column;gap:10px;min-width:0}",
			".usg_modelTrendHead{display:flex;align-items:center;justify-content:space-between;gap:10px}",
			".usg_modelTrendTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}",
			".usg_modelTrendBadge{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);border-radius:999px;corner-shape:round;padding:2px 8px;font-size:10px;line-height:16px;white-space:nowrap}",
			".usg_modelTrendPlot{position:relative;height:154px;border-radius:13px;background:linear-gradient(180deg,color-mix(in srgb,var(--usg-blue) 6%,transparent),transparent 72%);overflow:hidden}",
			".usg_modelTrendSvg{display:block;width:100%;height:100%;overflow:visible}",
			".usg_modelTrendGrid{stroke:var(--dsw-alias-border-l1);stroke-width:1;stroke-dasharray:3 5}",
			".usg_modelTrendArea{fill:var(--model-color);opacity:.075}",
			".usg_modelTrendLine{fill:none;stroke:var(--model-color);stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 2px 3px color-mix(in srgb,var(--model-color) 28%,transparent))}",
			".usg_modelTrendDot{fill:var(--dsw-alias-bg-layer-3);stroke:var(--model-color);stroke-width:2}",
			".usg_modelTrendHoverLine{stroke:var(--dsw-alias-label-caption);stroke-width:1;stroke-dasharray:3 4;pointer-events:none}",
			".usg_modelTrendHoverLayer{position:absolute;z-index:2;inset:0;cursor:crosshair}",
			".usg_modelTrendTooltip{box-sizing:border-box;position:absolute;z-index:3;top:8px;min-width:178px;max-width:230px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-overlay,var(--dsw-alias-bg-base));border:0.5px solid var(--dsw-alias-border-l1);border-radius:10px;padding:8px 10px;box-shadow:var(--dsw-elevation-panel);pointer-events:none}",
			".usg_modelTrendTooltipHead{display:flex;align-items:baseline;justify-content:space-between;gap:12px;margin-bottom:4px;font-size:11px;line-height:17px}",
			".usg_modelTrendTooltipHead strong{font-size:12px;font-weight:600}",
			".usg_modelTrendTooltipTotal{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap}",
			".usg_modelTrendTooltipRows{display:flex;flex-direction:column;gap:2px;border-top:0.5px solid var(--dsw-alias-border-l1);padding-top:4px}",
			".usg_modelTrendTooltipRow{display:grid;grid-template-columns:7px minmax(0,1fr) auto;align-items:center;gap:6px;color:var(--dsw-alias-label-secondary);font-size:10px;line-height:15px}",
			".usg_modelTrendTooltipRow span:nth-child(2){white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
			".usg_modelTrendTooltipRow b{color:var(--dsw-alias-label-primary);font-weight:600;font-variant-numeric:tabular-nums;white-space:nowrap}",
			".usg_modelTrendAxis{position:absolute;left:12px;right:12px;bottom:4px;display:flex;justify-content:space-between;color:var(--dsw-alias-label-caption);font-size:9px;line-height:12px;font-variant-numeric:tabular-nums;pointer-events:none}",
			".usg_modelTrendLegend{display:grid;grid-template-columns:repeat(auto-fit,minmax(132px,1fr));gap:6px}",
			".usg_modelTrendItem{min-width:0;border:0.5px solid var(--dsw-alias-border-l1);border-radius:9px;padding:6px 8px;display:grid;grid-template-columns:8px minmax(0,1fr) auto;align-items:center;gap:6px;background:color-mix(in srgb,var(--model-color) 5%,transparent);font:inherit;text-align:left;cursor:pointer;transition:opacity .15s,background .15s,border-color .15s}",
			".usg_modelTrendItem:hover{border-color:color-mix(in srgb,var(--model-color) 42%,var(--dsw-alias-border-l1));background:color-mix(in srgb,var(--model-color) 9%,transparent)}",
			".usg_modelTrendItem:focus-visible{outline:2px solid color-mix(in srgb,var(--model-color) 48%,transparent);outline-offset:1px}",
			".usg_modelTrendItem[aria-pressed=false]{opacity:.42;background:transparent}",
			".usg_modelTrendItem[aria-pressed=false] .usg_modelTrendName{text-decoration:line-through}",
			".usg_modelTrendSwatch{width:8px;height:8px;border-radius:999px;corner-shape:round;background:var(--model-color);box-shadow:0 0 8px color-mix(in srgb,var(--model-color) 48%,transparent)}",
			".usg_modelTrendName{min-width:0;color:var(--dsw-alias-label-secondary);font-size:10px;line-height:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
			".usg_modelTrendValue{color:var(--dsw-alias-label-primary);font-size:10px;font-weight:600;line-height:15px;font-variant-numeric:tabular-nums;white-space:nowrap}",
			".usg_heatStrip{grid-area:heat;border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:20px;padding:16px 18px;min-width:0;display:flex;flex-direction:column;gap:10px}",
			...
			".usg_chartBody{height:132px;border-bottom:0.5px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:2px;display:flex;position:relative;overflow:visible}",
			...
			".usg_hourInput{background:var(--dsw-alias-state-business-primary,#3b82f6);width:100%;min-height:1px;flex-basis:0}",
			".usg_hourOutput{background:var(--dsw-alias-state-success-primary,#22c55e);width:100%;min-height:1px;flex-basis:0}",
			".usg_dayBarsBody{height:132px;border-bottom:0.5px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:2px;display:flex;position:relative;overflow:visible}",
			...
			".usg_hourTooltip{position:absolute;z-index:60;top:8px;min-width:174px;max-width:230px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-overlay,var(--dsw-alias-bg-base));border:0;border-radius:10px;padding:8px 10px;box-shadow:var(--dsw-elevation-panel);font-size:11px;line-height:17px;pointer-events:auto}",
			".usg_dayTooltip{box-sizing:border-box;position:fixed;z-index:1200;max-width:min(230px,calc(100vw - 16px))}",
			...
			".usg_hourTooltipModels{border-top:0.5px solid var(--dsw-alias-border-l1);margin-top:5px;padding-top:4px;flex-direction:column;gap:1px;display:flex}",
			...
			".usg_detailsWorkbench{display:flex;flex-direction:column;gap:14px;min-width:0}",
			".usg_detailsHero{position:relative;overflow:hidden;border:0.5px solid var(--dsw-alias-border-l1);border-radius:20px;padding:18px 20px;background:linear-gradient(135deg,color-mix(in srgb,var(--usg-blue) 10%,var(--dsw-alias-bg-layer-3)),var(--dsw-alias-bg-layer-3) 58%);display:flex;align-items:center;justify-content:space-between;gap:18px}",
			".usg_detailsHero:after{content:\"\";position:absolute;width:180px;height:180px;right:-72px;top:-105px;border-radius:999px;background:color-mix(in srgb,var(--usg-blue) 12%,transparent);filter:blur(4px);pointer-events:none}",
			".usg_detailsHeroCopy{position:relative;z-index:1;min-width:0;display:flex;flex-direction:column;gap:3px}",
			".usg_detailsHeroTitle{color:var(--dsw-alias-label-primary);font-size:16px;font-weight:600;line-height:24px}",
			".usg_detailsHeroDesc{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}",
			".usg_detailsHeroStats{position:relative;z-index:1;display:flex;align-items:center;gap:12px;flex:none}",
			".usg_detailsHeroMetric{display:flex;align-items:baseline;gap:6px;color:var(--dsw-alias-label-tertiary);font-size:10px;white-space:nowrap}",
			".usg_detailsHeroValue{color:var(--dsw-alias-label-primary);font-size:24px;font-weight:600;line-height:30px;letter-spacing:-.02em;font-variant-numeric:tabular-nums}",
			".usg_detailsHeroMeta{color:var(--usg-blue);background:color-mix(in srgb,var(--usg-blue) 9%,var(--dsw-alias-bg-layer-3));border:0.5px solid color-mix(in srgb,var(--usg-blue) 20%,transparent);border-radius:999px;padding:4px 9px;font-size:10px;line-height:16px;white-space:nowrap}",
			".usg_detailsFilter{align-items:center;justify-content:space-between;gap:12px;display:flex;flex-wrap:wrap;padding:0 2px}",
			".usg_detailsCard{border-radius:20px;padding:16px 18px;gap:10px}",
			".usg_days{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:8px}",
			".usg_day{box-sizing:border-box;width:100%;min-height:68px;align-items:center;gap:10px;border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-module-platform);padding:10px 12px;font:inherit;text-align:left;cursor:pointer;display:grid;grid-template-columns:minmax(92px,auto) minmax(70px,1fr) auto auto;border-radius:13px;transition:transform .15s,border-color .15s,background .15s,box-shadow .15s}",
			".usg_day:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--usg-blue) 30%,var(--dsw-alias-border-l1));background:color-mix(in srgb,var(--usg-blue) 4%,var(--dsw-alias-bg-module-platform));box-shadow:0 6px 16px color-mix(in srgb,var(--usg-blue) 7%,transparent)}",
			".usg_day[data-active]{border-color:color-mix(in srgb,var(--usg-blue) 42%,var(--dsw-alias-border-l1));background:color-mix(in srgb,var(--usg-blue) 7%,var(--dsw-alias-bg-module-platform))}",
			".usg_dayDate{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500;line-height:18px;font-variant-numeric:tabular-nums;white-space:nowrap}",
			".usg_dayTokens{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:19px;font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap}",
			".usg_dayCost{color:var(--usg-blue);background:color-mix(in srgb,var(--usg-blue) 8%,transparent);border-radius:999px;padding:2px 7px;font-size:10px;line-height:16px;font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap}",
			".usg_dayTrack{background:var(--dsw-alias-bg-layer-2);border-radius:999px;height:7px;min-width:70px;overflow:hidden}",
			".usg_dayValueBar{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,color-mix(in srgb,var(--usg-blue) 60%,var(--dsw-alias-state-business-tertiary)),var(--usg-blue));box-shadow:0 0 8px color-mix(in srgb,var(--usg-blue) 25%,transparent)}",
			...
			".usg_detailContext{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0 0 7px;padding:0 2px;color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}",
			".usg_detailContext strong{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:600;font-variant-numeric:tabular-nums}",
			".usg_providerGroup{grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:6px;display:grid;margin-top:8px}",
			...
			".usg_modelRow{border:0.5px solid var(--dsw-alias-border-l2);border-radius:10px;padding:8px 10px;flex-direction:column;gap:4px;display:flex}",
			...
			".usg_modelBarTrack{background:var(--dsw-alias-bg-module-platform);border-radius:2px;height:5px;overflow:hidden}",
			...
			".usg_heatCell:disabled{cursor:default;opacity:.42;box-shadow:none}",
			...
			".usg_heatSwatch{width:10px;height:10px;border-radius:2px;background:var(--dsw-alias-bg-module-platform)}",
			// Limits & alert card
			".usg_limitCard{border:0.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;padding:14px 16px;flex-direction:column;gap:12px;display:flex}",
			...
			".usg_limitField{flex-direction:column;gap:4px;padding:12px 0;border-bottom:0.5px solid var(--dsw-alias-border-l2);display:flex}",
			...
			".usg_input{box-sizing:border-box;width:100%;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);border:0.5px solid var(--dsw-alias-border-l2);border-radius:8px;padding:0 12px;font:inherit;font-size:13px;line-height:1.5;box-shadow:none}",
			...
			".usg_toggleRow{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 0;border-bottom:0.5px solid var(--dsw-alias-border-l2)}",
			...
			".usg_providerPicker{border:0.5px solid var(--dsw-alias-border-l1);border-radius:10px;background:var(--dsw-alias-bg-layer-3);overflow:hidden}",
			...
			".usg_providerPicker[open]>summary{color:var(--dsw-alias-label-primary);border-bottom:0.5px solid var(--dsw-alias-border-l1)}",
			...
			".usg_alertCard{border:0.5px solid var(--dsw-alias-border-l2);border-radius:10px;padding:10px 12px;display:flex;flex-direction:column;gap:9px;background:var(--dsw-alias-bg-base)}",
			...
			".usg_alertCard input.usg_alertRange{appearance:none!important;display:block;width:100%;height:20px!important;margin:1px 0!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;cursor:pointer;position:relative;z-index:1}",
			".usg_alertCard input.usg_alertRange.is-overlay{position:absolute;inset:0;z-index:2;pointer-events:none}",
			".usg_alertCard input.usg_alertRange::-webkit-slider-runnable-track{height:6px;border-radius:999px;corner-shape:round;background:linear-gradient(to right,var(--usg-range-low,var(--usg-danger)) 0 var(--alert-percent),var(--usg-range-mid,var(--usg-warning)) var(--alert-percent) var(--critical-percent),var(--usg-range-high,var(--usg-success)) var(--critical-percent) 100%);box-shadow:inset 0 0 0 1px rgba(0,0,0,.12)}",
			".usg_alertCard input.usg_alertRange::-webkit-slider-thumb{appearance:none;width:16px;height:16px;margin-top:-5px;border:3px solid var(--usg-control-bg);border-radius:50%;corner-shape:round;background:var(--usg-action);box-shadow:0 0 0 2px rgba(0,0,0,.18);cursor:pointer;pointer-events:auto}",
			".usg_alertCard input.usg_alertRange::-moz-range-track{height:6px;border:0;border-radius:999px;corner-shape:round;background:linear-gradient(to right,var(--usg-range-low,var(--usg-danger)) 0 var(--alert-percent),var(--usg-range-mid,var(--usg-warning)) var(--alert-percent) var(--critical-percent),var(--usg-range-high,var(--usg-success)) var(--critical-percent) 100%);box-shadow:inset 0 0 0 1px rgba(0,0,0,.12)}",
			".usg_alertCard input.usg_alertRange::-moz-range-thumb{width:10px;height:10px;border:3px solid var(--usg-control-bg);border-radius:50%;corner-shape:round;background:var(--usg-action);box-shadow:0 0 0 2px rgba(0,0,0,.18);cursor:pointer;pointer-events:auto}",
			...
			".usg_statusBanner{position:relative;overflow:hidden;border-radius:8px;padding:8px 10px;font-size:12px;line-height:18px;display:flex;flex-direction:column;gap:6px;border:0.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}",
			...
			".usg_statusBanner[data-status=warning]:before{background:color-mix(in srgb,var(--dsw-alias-state-warn-primary) 16%,transparent)}",
			".usg_statusBanner[data-status=warning]{border-color:var(--dsw-alias-border-l2)!important;color:var(--dsw-alias-label-primary)}",
			".usg_statusBanner[data-status=warning] .usg_bannerTitle{color:var(--dsw-alias-state-warn-primary,#b26a00)}",
			".usg_statusBanner[data-status=exceeded]:before,.usg_statusBanner[data-status=blocked]:before{background:color-mix(in srgb,var(--dsw-alias-state-error-primary) 16%,transparent)}",
			".usg_statusBanner[data-status=stale],.usg_statusBanner[data-status=unavailable]{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary)}",
			...
			".usg_progressTrack{background:var(--dsw-alias-bg-module-platform);border-radius:999px;corner-shape:round;height:5px;overflow:hidden;width:100%}",
			".usg_progressBar{border-radius:999px;corner-shape:round;height:5px;transition:width .3s ease;background:var(--usg-blue)}",
			...
			".usg_tab[data-active=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);box-shadow:var(--dsw-elevation-panel)}",
			".usg_section[data-usage-billing-settings] .usg_tabs{position:static;top:auto;z-index:auto;align-items:flex-end;gap:22px;margin:2px 0 0;padding:0;border-radius:0;border-bottom:0.5px solid var(--dsw-alias-border-l2);background:0 0;box-shadow:none}",
			".usg_section[data-usage-billing-settings] .usg_tab{position:relative;border:0;border-bottom:0;border-radius:0;margin-bottom:0;padding:7px 1px 9px;background:transparent;box-shadow:none;font-size:13px;line-height:20px;font-weight:400}",
			...
			".usg_row{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 0;border-bottom:0.5px solid var(--dsw-alias-border-l2)}",
			...
			".usg_modelTable th{color:var(--dsw-alias-label-tertiary);font-weight:500;text-align:left;padding:6px 8px;border-bottom:0.5px solid var(--dsw-alias-border-l1);white-space:nowrap}",
			".usg_modelTable td{padding:6px 8px;border-bottom:0.5px solid var(--dsw-alias-border-l1);font-variant-numeric:tabular-nums}",
			".usg_modelTable th.usg_thGroup{text-align:center;border-bottom:0.5px solid var(--dsw-alias-border-l1)}",
			".usg_modelName{color:var(--dsw-alias-label-primary);font-weight:500;white-space:nowrap}",
			".usg_priceInput{width:88px;height:30px;box-sizing:border-box;background:var(--dsw-alias-bg-layer-1,var(--dsw-alias-bg-base));color:var(--dsw-alias-label-primary);border:0.5px solid var(--dsw-alias-border-l1);border-radius:6px;padding:0 8px;font:inherit;font-size:13px;text-align:right;font-variant-numeric:tabular-nums}",
			".usg_priceInput:focus{outline:none;border-color:var(--dsw-alias-brand-primary)}",
			".usg_section :is(button,input,select,summary):focus-visible,.usg_sidebarButton:focus-visible{outline:2px solid var(--dsw-alias-label-secondary);outline-offset:2px}",
			...
			".usg_alertItem{display:flex;flex-direction:column;gap:2px;border:0.5px solid var(--dsw-alias-border-l1);border-radius:8px;padding:6px 10px;font-size:12px;line-height:18px}",
			...
			".usg_dataStat{margin:8px 0 2px;border:0.5px solid var(--dsw-alias-border-l1);border-radius:14px;background:var(--dsw-alias-bg-layer-3);overflow:hidden}",
			".usg_dataStatMetrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}",
			".usg_dataStatCell{min-width:0;padding:14px 16px;border-right:0.5px solid var(--dsw-alias-border-l1)}",
			...
			".usg_dataStatRange{grid-template-columns:auto minmax(0,1fr);align-items:center;gap:16px;padding:11px 16px;border-top:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-module-platform);display:grid}",
			...
			".usg_dataActionPanel{margin-top:8px;border:0.5px solid var(--dsw-alias-border-l1);border-radius:14px;background:var(--dsw-alias-bg-layer-3);padding:14px 16px;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:center}",
			...
			".usg_tabs{flex-wrap:wrap}",
			".usg_workspaceWorkbench{grid-area:workspace;border:0.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:20px;padding:16px 18px;display:flex;flex-direction:column;gap:14px;min-width:0}",
			".usg_workspaceHead{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}",
			".usg_workspaceReportMeta{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px;font-variant-numeric:tabular-nums}",
			".usg_workspaceChartBody{display:grid;grid-template-columns:minmax(180px,240px) minmax(0,1fr);align-items:center;gap:18px;min-width:0}",
			".usg_workspaceDonut{width:min(100%,210px);aspect-ratio:1;margin:auto;filter:drop-shadow(0 8px 16px color-mix(in srgb,var(--usg-blue) 9%,transparent))}",
			".usg_workspaceDonutTrack{fill:none;stroke:var(--dsw-alias-bg-layer-2);stroke-width:18}",
			".usg_workspaceDonutSegment{fill:none;stroke:var(--workspace-color);stroke-width:18;transition:stroke-width .16s,opacity .16s;cursor:default}",
			".usg_workspaceDonutSegment:hover{stroke-width:22;opacity:.88}",
			".usg_workspaceDonutValue{fill:var(--dsw-alias-label-primary);font-size:14px;font-weight:650;font-variant-numeric:tabular-nums;text-anchor:middle}",
			".usg_workspaceDonutLabel{fill:var(--dsw-alias-label-tertiary);font-size:8px;text-anchor:middle}",
			".usg_workspaceList{display:flex;flex-direction:column;gap:9px;min-width:0}",
			".usg_workspaceChartRow{border-radius:13px;background:var(--dsw-alias-bg-module-platform);padding:10px 12px;display:flex;flex-direction:column;gap:8px;min-width:0}",
			".usg_workspaceRow{cursor:pointer;width:100%;background:0 0;border:0;padding:0;font:inherit;color:inherit;display:grid;grid-template-columns:14px 9px minmax(120px,1fr) auto auto;align-items:center;gap:10px;text-align:left}",
			".usg_workspaceCaret{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:1;transition:transform .15s}",
			".usg_workspaceChartRow[data-open=true] .usg_workspaceCaret{transform:rotate(90deg)}",
			".usg_workspaceColor{width:9px;height:9px;border-radius:999px;corner-shape:round;background:var(--workspace-color);box-shadow:0 0 9px color-mix(in srgb,var(--workspace-color) 42%,transparent)}",
			".usg_workspaceIdentity{min-width:0;display:flex;flex-direction:column;gap:1px}",
			".usg_workspaceName{color:var(--dsw-alias-label-primary);font-size:12px;line-height:18px;font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
			".usg_workspaceMeta{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px;white-space:nowrap}",
			".usg_workspaceShare{color:var(--workspace-color);font-size:11px;line-height:17px;font-weight:600;font-variant-numeric:tabular-nums;white-space:nowrap}",
			".usg_workspaceTokens{color:var(--dsw-alias-label-primary);font-size:13px;line-height:19px;font-weight:600;font-variant-numeric:tabular-nums;white-space:nowrap}",
			".usg_sessionList{display:flex;flex-direction:column;gap:5px;border-top:0.5px dashed var(--dsw-alias-border-l2);padding-top:7px}",
			".usg_sessionRow{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:10px;min-width:0}",
			".usg_sessionName{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
			".usg_sessionBreakdown{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px;white-space:nowrap;font-variant-numeric:tabular-nums}",
			".usg_sessionTokens{color:var(--dsw-alias-label-primary);font-size:12px;line-height:18px;font-variant-numeric:tabular-nums;white-space:nowrap}",
			"@container usage-pane (max-width:680px){.usg_rightbarBody .usg_overviewWorkbench{grid-template-columns:1fr;grid-template-areas:\"activity\" \"rail\" \"heat\" \"workspace\"}.usg_rightbarBody .usg_insightRail{display:flex}.usg_rightbarBody .usg_overviewWorkbench[data-usage-summary=true] .usg_insightRail{align-self:start;overflow:visible;contain:none}.usg_rightbarBody .usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageCard{flex:none;min-height:auto;overflow:visible}.usg_rightbarBody .usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageList{flex:none;min-height:auto;overflow-y:visible;scrollbar-gutter:auto}.usg_rightbarBody .usg_workspaceChartBody{grid-template-columns:1fr}}",
			"@media(max-width:700px){.usg_overviewWorkbench{grid-template-columns:1fr;grid-template-areas:\"activity\" \"rail\" \"heat\" \"workspace\"}.usg_header{grid-template-columns:minmax(0,1fr) auto}.usg_headerLeft{grid-column:1;grid-row:1}.usg_header>.usg_tabs{grid-column:1/-1;grid-row:2;justify-self:start}.usg_headerActions{grid-column:2;grid-row:1}.usg_insightRail{display:flex}.usg_overviewWorkbench[data-usage-summary=true] .usg_insightRail{align-self:start;overflow:visible;contain:none}.usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageCard{flex:none;min-height:auto;overflow:visible}.usg_overviewWorkbench[data-usage-summary=true] .usg_providerUsageList{flex:none;min-height:auto;overflow-y:visible;scrollbar-gutter:auto}.usg_hourCard .usg_chartBody{height:150px}.usg_workspaceChartBody{grid-template-columns:1fr}}",
			"@media(max-width:560px){.usg_panel.usg_panel{max-width:calc(100vw - 24px);border-radius:20px}.usg_panelBody{padding:12px}.usg_header{top:-12px;padding:0 0 10px}.usg_activityStage,.usg_heatStrip,.usg_workspaceWorkbench{padding:14px;border-radius:16px}.usg_activityLead{align-items:flex-start;flex-direction:column;gap:8px}.usg_activityValue{font-size:32px;line-height:38px}.usg_hourCard .usg_cardHead{align-items:flex-start;flex-direction:column}.usg_hourCard .usg_hourControls{width:100%;justify-content:space-between}.usg_providerGroup{grid-template-columns:1fr}.usg_insightRail{display:flex}.usg_insightRail .usg_statsRow{grid-template-columns:1fr 1fr}.usg_dataStatCell{padding:12px 10px}.usg_dataStatRange{grid-template-columns:1fr;gap:2px}.usg_dataStatRangeValue{text-align:left}.usg_dataActionPanel{grid-template-columns:1fr;gap:12px}.usg_dataActionControls{justify-content:flex-start}.usg_dataDangerPanel{align-items:flex-start;flex-direction:column}.usg_workspaceRow{grid-template-columns:14px 9px minmax(0,1fr) auto;grid-template-areas:\"caret color identity value\" \"caret color identity share\"}.usg_workspaceCaret{grid-area:caret}.usg_workspaceColor{grid-area:color}.usg_workspaceIdentity{grid-area:identity}.usg_workspaceShare{grid-area:share}.usg_workspaceTokens{grid-area:value}}",
			"@media(max-width:560px){.usg_detailsHero{align-items:flex-start;flex-direction:column}.usg_detailsHeroStats{width:100%;justify-content:space-between}.usg_days{grid-template-columns:1fr}.usg_day{grid-template-columns:minmax(88px,auto) minmax(54px,1fr) auto}.usg_dayCost{grid-column:1/-1;justify-self:start}}",
			"@media(max-width:640px){.usg_toggleGrid,.usg_limitGrid{grid-template-columns:1fr}}",
			"@media(max-width:420px){.usg_dataStatMetrics{grid-template-columns:1fr}.usg_dataStatCell{border-right:0;border-bottom:0.5px solid var(--dsw-alias-border-l1)}.usg_dataStatCell:last-child{border-bottom:0}.usg_dataActionControls{align-items:stretch;flex-direction:column}.usg_dataRetentionInput{width:100%}}",
			"@media(prefers-reduced-motion:reduce){.usg_section *,.usg_section *:before,.usg_section *:after,.usg_refreshGlyph{animation:none!important;transition:none!important;scroll-behavior:auto!important}.usg_day:hover{transform:none}}"
		].join("");
		...
		const S = {
			...
			rightbarBody: "usg_rightbarBody",
			mainBody: "usg_mainBody",
			section: "usg_section",
				header: "usg_header",
			...
			workspaceWorkbench: "usg_workspaceWorkbench",
			workspaceHead: "usg_workspaceHead",
			workspaceReportMeta: "usg_workspaceReportMeta",
			workspaceChartBody: "usg_workspaceChartBody",
			workspaceDonut: "usg_workspaceDonut",
			workspaceDonutTrack: "usg_workspaceDonutTrack",
			workspaceDonutSegment: "usg_workspaceDonutSegment",
			workspaceDonutValue: "usg_workspaceDonutValue",
			workspaceDonutLabel: "usg_workspaceDonutLabel",
			workspaceList: "usg_workspaceList",
			workspaceChartRow: "usg_workspaceChartRow",
			workspaceRow: "usg_workspaceRow",
			workspaceCaret: "usg_workspaceCaret",
			workspaceColor: "usg_workspaceColor",
			workspaceIdentity: "usg_workspaceIdentity",
			workspaceName: "usg_workspaceName",
			workspaceMeta: "usg_workspaceMeta",
			workspaceShare: "usg_workspaceShare",
			workspaceTokens: "usg_workspaceTokens",
			sessionList: "usg_sessionList",
			sessionRow: "usg_sessionRow",
			sessionName: "usg_sessionName",
			sessionBreakdown: "usg_sessionBreakdown",
			sessionTokens: "usg_sessionTokens",
			stat: "usg_stat",
			...
			statLabel: "usg_statLabel",
				...
				activityValue: "usg_activityValue",
					...
					modelFilterChip: "usg_modelFilterChip",
					modelFilterClear: "usg_modelFilterClear",
				...
				modelTrend: "usg_modelTrend",
				modelTrendHead: "usg_modelTrendHead",
				modelTrendTitle: "usg_modelTrendTitle",
				modelTrendBadge: "usg_modelTrendBadge",
				modelTrendPlot: "usg_modelTrendPlot",
				modelTrendSvg: "usg_modelTrendSvg",
				modelTrendGrid: "usg_modelTrendGrid",
				modelTrendArea: "usg_modelTrendArea",
				modelTrendLine: "usg_modelTrendLine",
				modelTrendDot: "usg_modelTrendDot",
				modelTrendHoverLine: "usg_modelTrendHoverLine",
				modelTrendHoverLayer: "usg_modelTrendHoverLayer",
				modelTrendTooltip: "usg_modelTrendTooltip",
				modelTrendTooltipHead: "usg_modelTrendTooltipHead",
				modelTrendTooltipTotal: "usg_modelTrendTooltipTotal",
				modelTrendTooltipRows: "usg_modelTrendTooltipRows",
				modelTrendTooltipRow: "usg_modelTrendTooltipRow",
				modelTrendAxis: "usg_modelTrendAxis",
				modelTrendLegend: "usg_modelTrendLegend",
				modelTrendItem: "usg_modelTrendItem",
				modelTrendSwatch: "usg_modelTrendSwatch",
				modelTrendName: "usg_modelTrendName",
				modelTrendValue: "usg_modelTrendValue",
			...
			detailsWorkbench: "usg_detailsWorkbench",
			detailsHero: "usg_detailsHero",
			detailsHeroCopy: "usg_detailsHeroCopy",
			detailsHeroTitle: "usg_detailsHeroTitle",
			detailsHeroDesc: "usg_detailsHeroDesc",
			detailsHeroStats: "usg_detailsHeroStats",
			detailsHeroMetric: "usg_detailsHeroMetric",
			detailsHeroValue: "usg_detailsHeroValue",
			detailsHeroMeta: "usg_detailsHeroMeta",
			detailsFilter: "usg_detailsFilter",
			detailsCard: "usg_detailsCard",
			detailSummary: "usg_detailSummary",
			detailContext: "usg_detailContext",
		...
		function cellColor(tokens, max) {
			...
			return {
				background: `color-mix(in srgb,var(--usg-blue) ${intensity}%,var(--usg-cellEmpty))`,
				color: intensity >= 60 ? "rgba(255,255,255,.95)" : "var(--dsw-alias-label-primary)"
			};
		}

		/** Keep a pointer-anchored tooltip inside the visible viewport. */
		function pointerTooltipStyle(x, y, width = 230, viewportWidth = window.innerWidth, viewportHeight = window.innerHeight) {
			const edge = 8;
			const gap = 12;
			const tooltipWidth = Math.max(0, Number(width) || 230);
			const availableWidth = Math.max(tooltipWidth + edge * 2, Number(viewportWidth) || tooltipWidth + edge * 2);
			const availableViewportHeight = Math.max(edge * 2, Number(viewportHeight) || 768);
			const anchorX = Number(x) || 0;
			const anchorY = Math.max(edge, Math.min(Number(y) || 0, availableViewportHeight - edge));
			const aboveSpace = Math.max(0, anchorY - gap - edge);
			const belowSpace = Math.max(0, availableViewportHeight - anchorY - gap - edge);
			const placeAbove = aboveSpace > belowSpace;
			return {
				position: "fixed",
				left: `${Math.round(Math.max(edge, Math.min(anchorX + gap, availableWidth - tooltipWidth - edge)))}px`,
				top: `${Math.round(anchorY + (placeAbove ? -gap : gap))}px`,
				transform: placeAbove ? "translateY(-100%)" : void 0,
				maxHeight: `${Math.floor(placeAbove ? aboveSpace : belowSpace)}px`,
				overflowY: "auto"
			};
		}
		...
		/** Short money: 3.14159 → "3.14" (USD cost), 0 → "0.00". Cents are
		 * truncated, not rounded, to match DeepSeek's downward per-call billing:
		 * an exact total just above the x.xx5 boundary must not display one
		 * cent higher than the official invoice. */
		function fmtMoney(value) {
			...
			const micros = Math.round(Math.abs(numeric) * 1e6);
			return `${numeric < 0 ? "-" : ""}${(Math.floor(micros / 1e4) / 100).toFixed(2)}`;
		}
		...
		function filterDay(day, modelId) {
			...
			/** Distinct bare model ids across all days, ranked by Token usage. */
			function modelChoiceRowsOf(days) {
				const totals = new Map();
				for (const day of days) {
					for (const model of day?.models ?? []) {
						const id = modelIdOf(model.model);
						if (id !== "" && id !== "unknown") totals.set(id, (totals.get(id) ?? 0) + (Number(model.tokens) || 0));
					}
				}
				return [...totals].map(([id, tokens]) => ({ id, tokens })).sort((left, right) => right.tokens - left.tokens || left.id.localeCompare(right.id));
			}

			function modelChoicesOf(days) {
				return modelChoiceRowsOf(days).map((item) => item.id);
			}
		...
		function recentDays(usageDays, today, activeDay = null) {
			...
			const cutoffKey = shiftDayKey(dayKey, -13);
				const recent = usageDays.filter((day) => day.date >= cutoffKey && day.date <= dayKey && (Number(day.tokens) || 0) > 0);
			...
			/** Token and priced-cost totals for the currently selected calendar range. */
			function summarizeRange(days) {
				...
				for (const day of days ?? []) {
					...
					if (models.length > 0) {
						for (const model of models) {
							if (model.cost === null || model.cost === void 0) {
								if ((Number(model.tokens) || 0) > 0) unpriced = true;
							} else costPriced += Number(model.cost) || 0;
						}
					} else if (day?.cost === null || day?.cost === void 0) {
						if ((Number(day?.tokens) || 0) > 0) unpriced = true;
					} else costPriced += Number(day.cost) || 0;
				}
				return { tokens, cost: unpriced ? null : costPriced, costPriced, unpriced };
			}

		/**
		 * Resolve the adjacent recorded day for single-day navigation. The recent
		 * list is newest-first, but the active day may be absent from it (a custom
		 * day older than the recent window), so resolve by date order instead of
		 * list position: "prev" picks the greatest recorded day before the active
		 * one, "next" the smallest recorded day after it.
		 */
		function adjacentDayKey(recentList, activeDayKey, direction) {
			if (!Array.isArray(recentList) || typeof activeDayKey !== "string") return null;
			let best = null;
			for (const day of recentList) {
				const date = day?.date;
				if (typeof date !== "string") continue;
				if (direction === "prev" && date < activeDayKey && (best === null || date > best)) best = date;
				else if (direction === "next" && date > activeDayKey && (best === null || date < best)) best = date;
			}
			return best;
		}
		...
		const RPC_ENDPOINTS = Object.freeze({
			...
			"usage-revision": Object.freeze({ GET: "usage/revision" }),
			workspaces: Object.freeze({ GET: "usage/workspaces" }),
		...
		function sidebarSummaryOf(usagePayload, balancePayload, limitsPayload, today, providerId = "deepseek-official", providerLabel = null, providerMeta = null) {
			...
			const status = limitStatus?.status;
				...
				todayVisible: todayValue !== null && todayValue > 0,
			...
			/** Translate plugin status tones into the host primitive vocabularies. */
			function hostTagTone(tone) {
				return tone === "ok" ? "success" : tone === "warn" ? "warning" : tone === "bad" ? "danger" : "neutral";
			}

			function hostDotState(tone) {
				return tone === "ok" ? "done" : tone === "warn" ? "warning" : tone === "bad" ? "error" : "idle";
			}
						...
						children: react_jsx_runtime.jsxs("div", {
							...
							children: [
								...
								weekdayLabels.map((item) => react_jsx_runtime.jsx("span", {
									...
									const currentDay = today ?? todayKey();
									const isToday = cell.key === currentDay;
									const isFuture = cell.key > currentDay;
									...
									return react_jsx_runtime.jsx("button", {
										...
										onClick: () => { if (!isFuture) onSelect(cell.key); }
									}, cell.key);
								}))
								]
							})
					}),
					hoveredCell !== null && typeof document !== "undefined" && document.body !== void 0 ? (() => {
						...
						return react_dom.createPortal(react_jsx_runtime.jsxs("div", {
							...
							"data-usage-heat-tooltip": true,
							style: pointerTooltipStyle(hoveredCell.x, hoveredCell.y),
							children: [
						...
						children: [
							react_jsx_runtime.jsx("span", { children: translate("usage.legendLess") }),
								[22, 42, 60, 80, 100].map((intensity, index) => react_jsx_runtime.jsx("span", {
									...
									style: { background: `color-mix(in srgb,var(--usg-blue) ${intensity}%,var(--usg-cellEmpty))` }
								}, index)),
		...
		function BalanceCard({ keys, providers = [], selectedProviderId, selectedKey, onSelectKey, account, accountLoading, accountError, balanceTone = "muted", translate, onRetry, animationKey = 0 }) {
			...
			const tone = providerKind === "local_usage" || status === "unsupported" || status === "refresh-disabled" ? "muted" : providerKind === "balance" && status === "ok" && balanceTone !== "muted" ? balanceTone : status === "ok" ? "ok"
					...
					: status === "empty" ? translate("balance.status.empty")
						: status === "not-configured" ? translate("balance.status.notConfigured")
							: status === "not-subscribed" ? translate("balance.status.subscriptionRequired")
								: status === "refresh-disabled" ? translate("balance.status.refreshDisabled")
			...
			const stackedPlanStatus = providerKind === "plan_quota" && ["unsupported", "not-configured", "not-subscribed", "refresh-disabled", "unauthorized", "rate-limited", "unavailable"].includes(status);
				...
				children: [
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							...
							providerKind !== "local_usage" && !stackedPlanStatus && react_jsx_runtime.jsx(primitives.Tag, { tone: hostTagTone(tone), children: statusText })
						]
					}),
		...
		function HourlyChart({ day, peakHours = [], weekendOffPeakFrom = "2026-08-23", money, translate, tokenMode = false }) {
			...
			const weekendOffPeak = isWeekendOffPeakDay(day?.date, weekendOffPeakFrom);
				...
				const hasUsage = day !== null && day !== void 0 && (!Array.isArray(day.models) || day.models.length > 0 || (Number(day.tokens) || 0) > 0 || hours.some((hour) => (Number(hour?.tokens) || 0) > 0 || (Number(hour?.cost) || 0) > 0));
				if (!hasUsage) return react_jsx_runtime.jsx("p", { className: S.note, "data-usage-chart-empty": true, children: translate("chart.empty") });
				return react_jsx_runtime.jsxs("div", {
				className: S.chart,
				children: [
					react_jsx_runtime.jsxs("div", {
					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							react_jsx_runtime.jsxs("span", { className: S.legendItem, children: [
								react_jsx_runtime.jsx("span", { className: S.legendSwatch, style: { background: "var(--dsw-alias-state-business-primary,#3b82f6)" } }),
								translate("usage.input")
							] }),
							react_jsx_runtime.jsxs("span", { className: S.legendItem, children: [
								react_jsx_runtime.jsx("span", { className: S.legendSwatch, style: { background: "var(--dsw-alias-state-success-primary,#22c55e)" } }),
		...
		function DayList({ days, selectedDay, onSelect, money, translate, tokenMode = false, animationKey = 0 }) {
			...
			return react_jsx_runtime.jsx("div", {
				...
				children: list.map((day) => react_jsx_runtime.jsxs("button", {
					type: "button",
					className: S.day,
					"data-usage-day-detail": day.date,
		...
		function DayDetail({ day, money, translate, tokenMode = false, animationKey = 0, showDate = false }) {
			...
			return react_jsx_runtime.jsxs("div", {
				...
				children: [
					showDate && react_jsx_runtime.jsxs("div", {
						className: S.detailContext,
						"data-usage-detail-date": day.date,
						children: [react_jsx_runtime.jsx("span", { children: translate("usage.selectedDay") }), react_jsx_runtime.jsx("strong", { children: day.date })]
					}),
					react_jsx_runtime.jsxs("div", {
		...
		const MODEL_TREND_COLORS = ["#4176e6", "#22b573", "#9b6cff", "#f59e0b", "#ef5da8"];

		/** Build a zero-filled, total-ranked model time series for the all-provider report. */
		function modelTrendSeriesOf(day, rangeDays, singleRange, limit = MODEL_TREND_COLORS.length) {
			const points = singleRange
				? (day?.hours ?? []).map((hour) => ({
					label: String(Number(hour.hour) || 0).padStart(2, "0"),
					title: String(Number(hour.hour) || 0).padStart(2, "0") + ":00",
					models: hour.models ?? []
				}))
				: (rangeDays ?? []).map((item) => ({
			...
			const rowsByPoint = points.map((point) => {
				const values = new Map();
				for (const row of point.models) {
					const model = String(row?.model ?? "");
					if (model === "") continue;
					values.set(model, (values.get(model) ?? 0) + (Number(row.tokens) || 0));
				}
				return values;
			});
			const totals = new Map();
			for (const values of rowsByPoint) {
				for (const [model, tokens] of values) totals.set(model, (totals.get(model) ?? 0) + tokens);
			}
			const series = [...totals.entries()]
				.sort((left, right) => right[1] - left[1] || left[0].localeCompare(right[0]))
				.slice(0, Math.max(1, Math.floor(Number(limit) || MODEL_TREND_COLORS.length)))
				.map(([model, total]) => ({
					model,
					total,
					values: rowsByPoint.map((values) => values.get(model) ?? 0)
				}));
			const maxValue = series.reduce((max, item) => Math.max(max, ...item.values), 0) || 1;
			return { labels: points.map((point) => point.label), titles: points.map((point) => point.title), series, maxValue };
		}

		/** Multi-model time-series chart used only by the all-provider report. */
		function ModelTrendChart({ day, rangeDays = [], singleRange = true, translate }) {
			const trend = modelTrendSeriesOf(day, rangeDays, singleRange);
			...
			const xOf = (index) => trend.labels.length <= 1
				? width / 2
				: chartLeft + (chartRight - chartLeft) * index / (trend.labels.length - 1);
			const yOf = (value) => chartBottom - (chartBottom - chartTop) * (Number(value) || 0) / trend.maxValue;
			const coordinatesOf = (values) => values.map((value, index) => xOf(index) + "," + yOf(value)).join(" ");
			const axisLabels = [...new Set([0, Math.floor((trend.labels.length - 1) / 2), trend.labels.length - 1])]
				.filter((index) => index >= 0 && trend.labels[index] !== void 0)
				.map((index) => trend.labels[index]);
			const visibleSeries = trend.series
				.map((item, colorIndex) => ({ ...item, colorIndex }))
				.filter((item) => !hiddenModels.has(item.model));
			const hoveredRows = hoveredIndex === null ? [] : visibleSeries.map((item) => ({
				...item,
				value: item.values[hoveredIndex] ?? 0
			}));
			const hoveredTotal = hoveredRows.reduce((sum, item) => sum + item.value, 0);
			const hoverRatio = hoveredIndex === null || trend.labels.length <= 1 ? 0 : hoveredIndex / (trend.labels.length - 1);
			const tooltipStyle = hoverRatio <= 0.18
				? { left: "8px" }
				: hoverRatio >= 0.82
					? { right: "8px" }
					: { left: 100 * hoverRatio + "%", transform: "translateX(-50%)" };
			const updateHoveredIndex = (event) => {
				const bounds = event.currentTarget.getBoundingClientRect();
				if (bounds.width <= 0 || trend.labels.length === 0) return;
				const ratio = Math.max(0, Math.min(1, (event.clientX - bounds.left) / bounds.width));
				setHoveredIndex(Math.round(ratio * (trend.labels.length - 1)));
			};
			...
			return react_jsx_runtime.jsxs("section", {
				className: S.modelTrend,
				"data-usage-model-trend": true,
				children: [
					react_jsx_runtime.jsxs("div", {
						className: S.modelTrendHead,
						children: [
							react_jsx_runtime.jsx("span", { className: S.modelTrendTitle, children: translate("usage.modelTrend") }),
							react_jsx_runtime.jsx("span", { className: S.modelTrendBadge, children: translate(singleRange ? "usage.modelTrendHourly" : "usage.modelTrendDaily") })
						]
					}),
					trend.series.length === 0 ? react_jsx_runtime.jsx("p", { className: S.note, children: translate("usage.noModelUsage") }) : react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, {
						children: [
							react_jsx_runtime.jsxs("div", {
								className: S.modelTrendPlot,
								children: [
									react_jsx_runtime.jsxs("svg", {
										className: S.modelTrendSvg,
										viewBox: "0 0 " + width + " 154",
										preserveAspectRatio: "none",
										role: "img",
										"aria-label": translate("usage.modelTrend"),
										children: [
											[chartTop, chartTop + 40, chartTop + 80, chartBottom].map((y, index) => react_jsx_runtime.jsx("line", {
												className: S.modelTrendGrid,
												x1: chartLeft,
												x2: chartRight,
												y1: y,
												y2: y
											}, "grid-" + index)),
											visibleSeries[0] && react_jsx_runtime.jsx("polygon", {
												className: S.modelTrendArea,
												style: { "--model-color": MODEL_TREND_COLORS[visibleSeries[0].colorIndex] },
												points: xOf(0) + "," + chartBottom + " " + coordinatesOf(visibleSeries[0].values) + " " + xOf(visibleSeries[0].values.length - 1) + "," + chartBottom
											}),
											visibleSeries.map((item) => react_jsx_runtime.jsxs("g", {
												style: { "--model-color": MODEL_TREND_COLORS[item.colorIndex] },
												children: [
													react_jsx_runtime.jsx("title", { children: modelIdOf(item.model) + " · " + fmt(item.total) + " tokens" }),
													react_jsx_runtime.jsx("polyline", { className: S.modelTrendLine, points: coordinatesOf(item.values), "data-usage-model-line": item.model }),
													item.values.map((value, pointIndex) => value <= 0 ? null : react_jsx_runtime.jsx("circle", {
														className: S.modelTrendDot,
														cx: xOf(pointIndex),
														cy: yOf(value),
														r: pointIndex === item.values.length - 1 ? 3.4 : 2.2
													}, item.model + "-" + pointIndex))
												]
											}, item.model)),
											hoveredIndex !== null && react_jsx_runtime.jsx("line", {
												className: S.modelTrendHoverLine,
												x1: xOf(hoveredIndex),
												x2: xOf(hoveredIndex),
												y1: chartTop,
												y2: chartBottom
											}),
											hoveredIndex !== null && visibleSeries.map((item) => react_jsx_runtime.jsx("circle", {
												className: S.modelTrendDot,
												style: { "--model-color": MODEL_TREND_COLORS[item.colorIndex] },
												cx: xOf(hoveredIndex),
												cy: yOf(item.values[hoveredIndex] ?? 0),
												r: 4.2
											}, "hover-" + item.model))
										]
									}),
									react_jsx_runtime.jsx("div", {
										className: S.modelTrendHoverLayer,
										"data-usage-model-trend-hover": true,
										onMouseMove: updateHoveredIndex,
										onMouseLeave: () => setHoveredIndex(null)
									}),
									hoveredIndex !== null && react_jsx_runtime.jsxs("div", {
										className: S.modelTrendTooltip,
										"data-usage-model-trend-tooltip": true,
										style: tooltipStyle,
										children: [
											react_jsx_runtime.jsxs("div", { className: S.modelTrendTooltipHead, children: [
												react_jsx_runtime.jsx("strong", { children: trend.titles[hoveredIndex] ?? trend.labels[hoveredIndex] }),
												react_jsx_runtime.jsx("span", { className: S.modelTrendTooltipTotal, children: fmt(hoveredTotal) + " tokens" })
											] }),
											react_jsx_runtime.jsx("div", { className: S.modelTrendTooltipRows, children: hoveredRows.map((item) => react_jsx_runtime.jsxs("div", {
												className: S.modelTrendTooltipRow,
												children: [
													react_jsx_runtime.jsx("span", { className: S.modelTrendSwatch, style: { "--model-color": MODEL_TREND_COLORS[item.colorIndex] } }),
													react_jsx_runtime.jsx("span", { children: modelIdOf(item.model) }),
													react_jsx_runtime.jsx("b", { children: fmt(item.value) })
												]
											}, item.model)) })
										]
									}),
									react_jsx_runtime.jsx("div", {
										className: S.modelTrendAxis,
										"aria-hidden": true,
										children: axisLabels.map((label, index) => react_jsx_runtime.jsx("span", { children: label }, label + "-" + index))
									})
								]
							}),
							react_jsx_runtime.jsx("div", {
								className: S.modelTrendLegend,
								children: trend.series.map((item, index) => react_jsx_runtime.jsxs("button", {
									type: "button",
									className: S.modelTrendItem,
									style: { "--model-color": MODEL_TREND_COLORS[index] },
									title: item.model,
									"data-usage-model-toggle": item.model,
									"aria-pressed": !hiddenModels.has(item.model),
									onClick: () => toggleModel(item.model),
									children: [
										react_jsx_runtime.jsx("span", { className: S.modelTrendSwatch }),
										react_jsx_runtime.jsx("span", { className: S.modelTrendName, children: modelIdOf(item.model) }),
										react_jsx_runtime.jsx("span", { className: S.modelTrendValue, children: fmt(item.total) })
									]
								}, item.model))
							})
						]
		 ...
		 */
		/** Display name for one workspace path: its final path segment. */
		...
		/** Durable conversation title used by a workspace drill-down row. */
		function sessionLabelOf(title) {
			return typeof title === "string" && title.trim() !== "" ? title : "";
		}

		/** Inclusive Beijing-calendar window for a workspace range preset. */
		function workspaceRangeWindow(range, today, customFrom, customTo) {
			if (range === "all") return { from: null, to: null };
			if (range === "custom") return {
				from: typeof customFrom === "string" && customFrom !== "" ? customFrom : null,
				to: typeof customTo === "string" && customTo !== "" ? customTo : null
			};
			const days = daysInRange(range, today);
			if (!Array.isArray(days) || days.length === 0) return { from: null, to: null };
			return { from: days[0], to: days[days.length - 1] };
		}

		const WORKSPACE_CHART_COLORS = ["#4176e6", "#22b573", "#9b6cff", "#f59e0b", "#ef5da8", "#27b6c7", "#7b879b"];

		/**
		 * Workspace distribution chart for the all-provider report. It follows the
		 * report's inclusive Beijing-calendar window and keeps per-session drill-down.
		 */
		function WorkspaceUsageView({ translate, serverToday, range = "7d", customFrom = null, customTo = null, refreshKey = 0 }) {
			const [payload, setPayload] = react.useState(null);
			const [loading, setLoading] = react.useState(true);
			const [error, setError] = react.useState(null);
			const [expanded, setExpanded] = react.useState(null);
			const loader = react.useRef(createLoader());
			const window = react.useMemo(() => workspaceRangeWindow(range, serverToday, customFrom, customTo), [range, serverToday, customFrom, customTo]);
			const load = react.useCallback(() => {
				...
				return fetchJson(`/api/usage-stats/workspaces${query === "" ? "" : `?${query}`}`).then((result) => {
					...
					if (loader.current.isCurrent(request)) setLoading(false);
				});
			...
			react.useEffect(() => {
				load();
				return () => { loader.current.start(); };
			}, [load, refreshKey]);
			const workspaces = payload !== null && Array.isArray(payload.workspaces) ? payload.workspaces : [];
			const workspaceTokens = workspaces.reduce((sum, row) => sum + (Number(row.tokens) || 0), 0);
			let donutOffset = 0;
			const donutRows = workspaces.map((row, index) => {
				const tokens = Number(row.tokens) || 0;
				const share = workspaceTokens > 0 ? tokens / workspaceTokens * 100 : 0;
				const segment = {
					row,
					tokens,
					share,
					offset: donutOffset,
					color: WORKSPACE_CHART_COLORS[index % WORKSPACE_CHART_COLORS.length]
				};
				donutOffset += share;
				return segment;
			});
			const sessionCount = workspaces.reduce((sum, row) => sum + (Array.isArray(row.sessions) ? row.sessions.length : 0), 0);
			return react_jsx_runtime.jsxs("div", {
				className: S.workspaceWorkbench,
				"data-usage-workspace": true,
				"data-usage-workspace-chart": true,
				children: [
					react_jsx_runtime.jsxs("div", {
						className: S.workspaceHead,
						children: [
							react_jsx_runtime.jsx("span", { className: S.cardTitle, children: translate("workspace.title") }),
							payload !== null && react_jsx_runtime.jsx("span", {
								className: S.workspaceReportMeta,
								children: translate("workspace.reportMeta", { tokens: fmt(payload.tokens), workspaces: fmt(workspaces.length), sessions: fmt(sessionCount) })
							})
						]
					}),
					error !== null
						? react_jsx_runtime.jsxs("div", { className: S.error, role: "alert", children: [
							react_jsx_runtime.jsx("span", { children: translate("workspace.error", { message: error }) }),
							react_jsx_runtime.jsx("button", { type: "button", className: S.retry, disabled: loading, onClick: load, children: translate("action.retry") })
						] })
						: loading && payload === null
							? react_jsx_runtime.jsx("p", { className: S.note, children: translate("workspace.loading") })
							: react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, { children: [
								workspaces.length === 0
									? react_jsx_runtime.jsx("p", { className: S.note, children: translate("workspace.empty") })
									: react_jsx_runtime.jsxs("div", { className: S.workspaceChartBody, children: [
										react_jsx_runtime.jsxs("svg", {
											className: S.workspaceDonut,
											viewBox: "0 0 160 160",
											role: "img",
											"aria-label": translate("workspace.title"),
											"data-usage-workspace-donut": true,
											children: [
												react_jsx_runtime.jsx("circle", { className: S.workspaceDonutTrack, cx: 80, cy: 80, r: 53, pathLength: 100 }),
												donutRows.map((item) => {
													const label = workspaceLabelOf(item.row.workspace) || translate("workspace.unknown");
													return react_jsx_runtime.jsx("circle", {
														className: S.workspaceDonutSegment,
														cx: 80,
														cy: 80,
														r: 53,
														pathLength: 100,
														transform: "rotate(-90 80 80)",
														style: { "--workspace-color": item.color, strokeDasharray: `${item.share} ${100 - item.share}`, strokeDashoffset: -item.offset },
														"data-usage-workspace-segment": item.row.workspace || "__unknown__",
														children: react_jsx_runtime.jsx("title", { children: `${label} · ${fmt(item.tokens)} tokens · ${item.share.toFixed(1)}%` })
													}, item.row.workspace || "__unknown__");
												}),
												react_jsx_runtime.jsx("text", { className: S.workspaceDonutValue, x: 80, y: 78, children: fmt(workspaceTokens) }),
												react_jsx_runtime.jsx("text", { className: S.workspaceDonutLabel, x: 80, y: 94, children: "tokens" })
											]
										}),
										react_jsx_runtime.jsx("div", { className: S.workspaceList, "data-usage-workspace-list": true, children: donutRows.map((item) => {
										const row = item.row;
										const key = typeof row.workspace === "string" && row.workspace !== "" ? row.workspace : "__unknown__";
										const open = expanded === key;
										const label = workspaceLabelOf(row.workspace);
										const sessions = Array.isArray(row.sessions) ? row.sessions : [];
										const shareLabel = item.share >= 10 ? Math.round(item.share) + "%" : item.share.toFixed(1) + "%";
										return react_jsx_runtime.jsxs("div", { className: S.workspaceChartRow, style: { "--workspace-color": item.color }, "data-open": open ? "true" : "false", "data-workspace-key": key, children: [
											react_jsx_runtime.jsxs("button", { type: "button", className: S.workspaceRow, title: row.workspace || translate("workspace.unknown"), "aria-expanded": open, onClick: () => setExpanded(open ? null : key), children: [
												react_jsx_runtime.jsx("span", { className: S.workspaceCaret, children: "\u25b6" }),
												react_jsx_runtime.jsx("span", { className: S.workspaceColor }),
												react_jsx_runtime.jsxs("span", { className: S.workspaceIdentity, children: [
													react_jsx_runtime.jsx("span", { className: S.workspaceName, children: label === "" ? translate("workspace.unknown") : label }),
													react_jsx_runtime.jsx("span", { className: S.workspaceMeta, children: translate("workspace.sessions", { count: String(sessions.length) }) })
												]}),
												react_jsx_runtime.jsx("span", { className: S.workspaceShare, children: shareLabel }),
												react_jsx_runtime.jsx("span", { className: S.workspaceTokens, children: fmt(row.tokens) })
											]}),
											open && react_jsx_runtime.jsx("div", { className: S.sessionList, children: sessions.map((session) => react_jsx_runtime.jsxs("div", { className: S.sessionRow, title: session.title || session.sessionId || translate("workspace.unknownSession"), children: [
												react_jsx_runtime.jsx("span", { className: S.sessionName, children: sessionLabelOf(session.title) === "" ? translate("workspace.unknownSession") : sessionLabelOf(session.title) }),
												react_jsx_runtime.jsx("span", { className: S.sessionBreakdown, children: `${translate("usage.input")} ${fmt(session.inputTokens)} · ${translate("usage.output")} ${fmt(session.outputTokens)} · ${translate("usage.cacheRead")} ${fmt(session.cacheReadTokens)}` }),
												react_jsx_runtime.jsx("span", { className: S.sessionTokens, children: fmt(session.tokens) })
											]}, session.sessionId || "__unknown__")) })
										]}, key);
									})})
								]}),
								payload?.hasEstimatedHistory === true && react_jsx_runtime.jsx("p", { className: S.note, children: translate("workspace.estimatedNote") })
							]})
				]
			});
		}
		...
		function UsageStatsSection({ t, onClose, onOpenSettings }) {
			...
			const loadUsage = react.useCallback(() => {
				...
				if (activeTab === "overview" && !selectedProviderId) { setUsageLoading(false); return Promise.resolve(); }
				const usageProviderId = activeTab === "overview" ? selectedProviderId : null;
			...
			const loadBalance = react.useCallback((keyRef, force = false) => {
			...
			react.useEffect(() => {
				...
				setLoaded(false);
				setError(null);
				const refreshVisible = () => { if (!document.hidden) loadUsage(); };
				loadUsage();
			...
			}, [loadKeys, loadProviders, loadLimitStatus]);
			react.useEffect(() => {
				setSelectedKey((current) => {
			...
			const filteredDays = react.useMemo(() => days.map(day => filterDay(day, activeModelFilter)), [usage, activeModelFilter]);
				const filteredDayMap = react.useMemo(() => new Map(filteredDays.map(day => [day.date, day])), [filteredDays]);
				const stats = react.useMemo(() => summarize(days, activeModelFilter, serverToday), [usage, activeModelFilter, serverToday]);
				const modelChoices = react.useMemo(() => modelChoiceRowsOf(days), [usage]);
				react.useEffect(() => {
					if (usage !== null && modelFilter !== "" && !modelChoices.some((item) => item.id === modelFilter)) setModelFilter("");
				}, [usage, modelFilter, modelChoices]);
			...
			const filteredActiveDay = filteredDayMap.get(activeDayKey) ?? null;
			const singleRange = timeRange === "today" || timeRange === "yesterday" || timeRange === "custom";
			const rangeDays = daysInRange(timeRange, serverToday).map((date) => filteredDayMap.get(date) ?? { date, tokens: 0, cost: null });
			...
			const focusedRangeDay = focusedRangeSourceDay;
			...
			const providerUsageCapacity = singleRange
				...
				: rangeDays.reduce((max, day) => Math.max(max, (day.models ?? []).length), 0);
			const recentList = recentDays(filteredDays, serverToday, activeDayKey);
				...
				const rangeSummary = summarizeRange(rangeDays);
				const rangeLabel = timeRange === "custom" ? selectedDay ?? serverToday : timeRangeOptions.find((option) => option.value === timeRange)?.label ?? translate("usage.today");
				const activityLabel = timeRange === "today"
					? translate(isSummaryTab ? "usage.activityAllProviders" : "usage.activityToday")
					: translate(isSummaryTab ? "usage.activityRangeAllProviders" : "usage.activityRange", { range: rangeLabel });
				const rangeCostLabel = timeRange === "today"
					? translate(rangeSummary.unpriced ? "usage.costTodayUnpriced" : "usage.costToday")
					: translate(rangeSummary.unpriced ? "usage.costRangeUnpriced" : "usage.costRange", { range: rangeLabel });
			const heatDayMap = react.useMemo(() => new Map(filteredDays.map((day) => [day.date, { ...day, tokens: day.tokens, cacheHitRate: hitRateOf(day), day }])), [filteredDays]);
				...
				children: [
					react_jsx_runtime.jsxs("div", {
						...
						react_jsx_runtime.jsxs("div", {
							...
							onKeyDown: event => navigateTabs(event, ["summary", "overview", "details"], next => next === "details" ? showDetails() : setActiveTab(next)),
							children: [
					...
					loaded === false ? react_jsx_runtime.jsx("p", { className: S.note, children: translate("usage.loading") }) : (activeTab === "summary" || activeTab === "overview") ? react_jsx_runtime.jsxs("div", {
						...
						children: [
								...
								children: [
									react_jsx_runtime.jsxs("div", {
										...
										children: [
											...
											"data-usage-range-metric": timeRange,
											children: [
												react_jsx_runtime.jsx("span", { className: S.activityKicker, children: activityLabel }),
												react_jsx_runtime.jsxs("span", { className: S.activityReading, children: [
							react_jsx_runtime.jsx(AnimatedNumber, { className: S.activityValue, value: rangeSummary.tokens, animationKey: refreshTick }),
														react_jsx_runtime.jsx("span", { className: S.activityUnit, children: translate("usage.tokenUnit") })
													] })
												]
											}),
										showCostStat && react_jsx_runtime.jsxs("span", {
											className: S.activityMeta,
											title: rangeSummary.unpriced ? translate("usage.unpricedNote") : void 0,
							children: [
								rangeCostLabel,
								" ",
							react_jsx_runtime.jsx(AnimatedNumber, { value: rangeSummary.costPriced ?? rangeSummary.cost, format: money, animationKey: refreshTick }),
								rangeSummary.unpriced ? " *" : ""
								]
											})
										]
									}),
									...
									react_jsx_runtime.jsxs("div", {
										...
										children: [
											react_jsx_runtime.jsxs("span", {
												...
												translate(isSummaryTab ? "usage.globalTimeline" : singleRange ? "usage.hourly" : "usage.daily")
												]
											}),
											react_jsx_runtime.jsxs("div", {
										className: S.hourControls,
										children: [
											!isSummaryTab && modelFilter !== "" && react_jsx_runtime.jsxs("button", {
												type: "button",
												className: S.modelFilterChip,
												"data-usage-model-filter": modelFilter,
												"aria-label": translate("usage.clearModelFilter", { model: modelFilter }),
												title: translate("usage.clearModelFilter", { model: modelFilter }),
												onClick: () => setModelFilter(""),
												children: [react_jsx_runtime.jsx("span", { children: translate("usage.activeModelFilter", { model: modelFilter }) }), react_jsx_runtime.jsx("span", { className: S.modelFilterClear, "aria-hidden": true, children: "×" })]
											}),
											react_jsx_runtime.jsx("select", {
												...
												singleRange && react_jsx_runtime.jsxs("div", {
													className: S.dayNav,
													children: [
																									react_jsx_runtime.jsx("button", { type: "button", className: S.navButton, "aria-label": translate("action.prevDay"), disabled: adjacentDayKey(recentList, activeDayKey, "prev") === null, onClick: () => { const target = adjacentDayKey(recentList, activeDayKey, "prev"); if (target !== null) pickDay(target); }, children: react_jsx_runtime.jsx(primitives.IconChevronLeftOutline14, { size: 12 }) }),
												react_jsx_runtime.jsx("span", { className: S.dayTitle, children: dayLabel(activeDayKey, translate) }),
																									react_jsx_runtime.jsx("button", { type: "button", className: S.navButton, "aria-label": translate("action.nextDay"), disabled: adjacentDayKey(recentList, activeDayKey, "next") === null, onClick: () => { const target = adjacentDayKey(recentList, activeDayKey, "next"); if (target !== null) pickDay(target); }, children: react_jsx_runtime.jsx(primitives.IconChevronRightOutline14, { size: 12 }) }),
									...
									singleRange ? react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, {
										children: [
											...
											filteredActiveDay !== null && (isSummaryTab ? react_jsx_runtime.jsx(ModelTrendChart, {
												day: filteredActiveDay,
												rangeDays,
												singleRange,
												translate
											}) : react_jsx_runtime.jsx(DayDetail, { day: filteredActiveDay, money, translate, tokenMode, animationKey: refreshTick }))
										]
										...
										children: [
											...
											isSummaryTab ? react_jsx_runtime.jsx(ModelTrendChart, {
												day: filteredActiveDay,
												rangeDays,
												singleRange,
												translate
										}) : focusedRangeDay !== null && react_jsx_runtime.jsx(DayDetail, { day: focusedRangeDay, money, translate, tokenMode, animationKey: refreshTick, showDate: true })
										]
									})
								]
										})
							...
							react_jsx_runtime.jsxs("aside", {
								...
								children: [
									...
									translate,
									onRetry: () => loadBalance(selectedKey, true),
							...
							isSummaryTab && react_jsx_runtime.jsx(WorkspaceUsageView, {
								translate,
								serverToday,
								range: timeRange,
						...
						className: S.detailsWorkbench,
						"data-usage-details": true,
						children: [
							react_jsx_runtime.jsxs("section", {
								className: S.detailsHero,
								"data-usage-details-hero": true,
								children: [
									react_jsx_runtime.jsxs("div", { className: S.detailsHeroCopy, children: [
										react_jsx_runtime.jsx("span", { className: S.detailsHeroTitle, children: translate("usage.detailsTitle") }),
										react_jsx_runtime.jsx("span", { className: S.detailsHeroDesc, children: translate("usage.detailsDescAllProviders") })
									] }),
									react_jsx_runtime.jsxs("div", { className: S.detailsHeroStats, children: [
										react_jsx_runtime.jsxs("span", { className: S.detailsHeroMetric, children: [
											react_jsx_runtime.jsx(AnimatedNumber, { className: S.detailsHeroValue, value: recentList.reduce((sum, day) => sum + (Number(day.tokens) || 0), 0), animationKey: refreshTick }),
											translate("usage.tokenUnit")
										] }),
										react_jsx_runtime.jsx("span", { className: S.detailsHeroMeta, children: translate("usage.detailsDays", { count: fmt(recentList.length) }) })
									] })
								]
							}),
							react_jsx_runtime.jsxs("label", {
								className: S.detailsFilter,
								children: [
									...
									react_jsx_runtime.jsx("select", {
										...
										...modelChoices.map((model) => react_jsx_runtime.jsx("option", { value: model.id, children: `${model.id} · ${fmt(model.tokens)}` }, model.id))
										]
									})
								]
							}),
							react_jsx_runtime.jsxs("section", {
								className: `${S.card} ${S.detailsCard}`,
								children: [
		 ...
		 * our own trigger (never a broad substring match on labels). Current
		 * Harness slot seats add several wrapper layers, so the bounded walk
		 * covers the complete footer stack rather than assuming shallow siblings. The
		 ...
		 */
		/**
		 * Candidate roots for the settings navigation lookup, most specific
		 * first: the open settings dialog (the host's `role="dialog"
		 * aria-modal="true"` shell), then the document as a fallback. Scoping to
		 * the dialog keeps a page-wide text match from clicking an unrelated
		 * control that happens to share the section label.
		 */
		function settingsSectionRoots() {
			const roots = [];
			const dialogs = document.querySelectorAll('[role="dialog"][aria-modal="true"]');
			for (let index = dialogs.length - 1; index >= 0; index -= 1) {
				const dialog = dialogs[index];
				if (dialog.hasAttribute("hidden") || dialog.getAttribute("aria-hidden") === "true") continue;
				roots.push(dialog);
			}
			roots.push(document);
			return roots;
		...
		/**
		 * Whether one navigation candidate is a clickable, not-hidden control.
		 * Uses declared visibility instead of layout rects so the lookup still
		 * works in a layout-less DOM; the dialog scope already bounds the search.
		 */
		function isSettingsSectionCandidate(node) {
			if (node === null || typeof node !== "object") return false;
			if (typeof node.hasAttribute === "function" && (node.hasAttribute("hidden") || node.hasAttribute("disabled"))) return false;
			if (typeof node.getAttribute === "function" && node.getAttribute("aria-hidden") === "true") return false;
			const style = node.style;
			return style === void 0 || style === null || (style.display !== "none" && style.visibility !== "hidden");
		}

		function openHarnessSettings(layerEl) {
			let host = layerEl?.parentElement ?? null;
			let opened = false;
			for (let depth = 0; host !== null && depth < 12; depth += 1) {
				const button = host.querySelector?.('button[aria-haspopup="dialog"]:not([data-usage-stats-trigger])');
			...
			let attempts = 0;
			const selectSection = () => {
				for (const root of settingsSectionRoots()) {
					const candidates = root.querySelectorAll("button,[role=button],a,[tabindex]");
					for (const candidate of candidates) {
						if (labels.has(candidate.textContent?.trim()) && isSettingsSectionCandidate(candidate)) {
							candidate.click();
							return;
						}
					}
		...
		const USAGE_STATS_TAB_ID = "@wannanbigpig/dsh-usage-stats/sidebar";
		const USAGE_STATS_TAB_KIND = "usage-stats";
		const USAGE_STATS_MAIN_PANEL_ID = "@wannanbigpig/dsh-usage-stats/main";

		/** Open the host's session-scoped right Sidebar when one is mounted. */
		function openUsageStatsInRightSidebar(ctx) {
			const sidebar = typeof ctx?.get === "function" ? ctx.get("sidebarRight") : null;
			if (sidebar === null || sidebar === void 0 || typeof sidebar.openTab !== "function") return false;
			try {
				sidebar.openTab(USAGE_STATS_TAB_KIND);
				return true;
			} catch {
				return false;
			}
		...
		/** Open the root-scoped native main panel when no Session Sidebar exists. */
		function openUsageStatsInGlobalPanel(ctx) {
			const layout = typeof ctx?.get === "function" ? ctx.get("layout") : null;
			if (layout === null || layout === void 0 || typeof layout.selectPanel !== "function") return false;
			try {
				layout.selectPanel(USAGE_STATS_MAIN_PANEL_ID);
				return true;
			} catch {
				return false;
			}
		...
		/** Prefer the Session Sidebar, then the current host's global main-panel seam. */
		function openUsageStatsInHostSurface(ctx) {
			return openUsageStatsInRightSidebar(ctx) || openUsageStatsInGlobalPanel(ctx);
		}

		/** Query-center body hosted by the latest Harness right Sidebar. */
		function UsageStatsRightSidebar({ t }) {
			return react_jsx_runtime.jsx("div", {
				className: S.rightbarBody,
				"data-usage-stats-sidebar-tab": true,
				children: react_jsx_runtime.jsx(UsageStatsSection, {
					t,
					onOpenSettings: () => openHarnessSettings(typeof document === "undefined" ? null : document.querySelector("[data-usage-stats-trigger]"))
				})
			});
		}

		/** Query-center body hosted by the latest Harness root-scoped main slot. */
		function UsageStatsMainPanel({ t, closePanel }) {
			return react_jsx_runtime.jsx("div", {
				className: S.mainBody,
				"data-usage-stats-main-panel": true,
				children: react_jsx_runtime.jsx(UsageStatsSection, {
					t,
					onClose: closePanel,
					onOpenSettings: () => openHarnessSettings(typeof document === "undefined" ? null : document.querySelector("[data-usage-stats-trigger]"))
		...
		function LimitsCard({ keys, selectedKey, onSelectKey, pricing, todayCost, providers = [], providerId = "deepseek-official", providerKind = "balance", translate, onLimitsUpdated }) {
			...
			const period = rule?.period === "monthly" ? "monthly" : "daily";
			const spendField = period === "monthly" ? "monthlyCostLimit" : "dailyCostLimit";
			...
			const saveAmount = (event, field) => {
				const value = parseAmount(event.currentTarget.value);
				if (value === void 0) {
					setSaved(false);
					setError(translate("limits.invalidAmount"));
					return;
				}
			...
			const spendBannerMessage = ["daily_cost", "monthly_cost", "unpriced"].includes(currentStatus?.reason) ? currentStatus.message : "";
			const currentStatusTone = limitToneOf(spendBannerStatus);
			const statusMonthly = currentStatus?.period === "monthly";
			const currentLimit = Number(statusMonthly ? currentStatus?.monthlyCostLimit : currentStatus?.dailyCostLimit) || 0;
			const currentSpent = Number(statusMonthly ? currentStatus?.monthlyCost : currentStatus?.todayCost ?? todayCost) || 0;
			const currentPercent = currentLimit > 0 ? Math.min(100, Math.round(100 * currentSpent / currentLimit)) : 0;
			const providerContext = react_jsx_runtime.jsx("p", { className: S.note, children: translate("limits.providerSwitchDesc") });
			if (selectedLimitProvider?.id !== "deepseek-official" || selectedLimitProviderKind !== "balance") return react_jsx_runtime.jsxs("div", {
				...
				children: [
					...
					supportsPlanQuota(selectedLimitProvider) || isZaiProvider(selectedLimitProvider?.id)
						? react_jsx_runtime.jsx(PlanQuotaCard, { translate, windows: selectedLimitProvider?.planQuota?.windows })
				...
				children: [
					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							...
							react_jsx_runtime.jsx("span", { className: S.note, role: "status", children: translate(saving ? "limits.saving" : saved ? "settings.saved" : "settings.autoSave") })
						]
					}),
					error !== null && react_jsx_runtime.jsxs("div", {
						className: S.error,
					...
					currentStatus !== null && currentLimit > 0 && react_jsx_runtime.jsxs("div", {
						...
						children: [
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									react_jsx_runtime.jsx("span", { className: S.bannerTitle, children: translate(statusMonthly ? "limits.monthlyLimitStatus" : "limits.dailyLimitStatus") }),
								spendBannerActive ? react_jsx_runtime.jsx(primitives.Tag, { tone: hostTagTone(currentStatusTone), children: translate(limitStatusLabelKey(spendBannerStatus)) }) : null
								]
							}),
							currentLimit > 0 && react_jsx_runtime.jsx("span", { className: S.bannerMsg, children: translate(statusMonthly ? "limits.monthlyProgress" : "limits.progress", { spent: fmtMoney(currentSpent), limit: currentLimit.toFixed(2), percent: currentPercent }) }),
					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							...
							react_jsx_runtime.jsxs("label", { className: S.row, children: [
								react_jsx_runtime.jsx("span", { className: S.rowLabel, children: translate("limits.period") }),
								react_jsx_runtime.jsxs("select", { className: S.select, "aria-label": translate("limits.period"), value: period, disabled,
									onChange: event => { patchLocal({ period: event.target.value }); handleSave({ period: event.target.value }); },
									children: [react_jsx_runtime.jsx("option", { value: "daily", children: translate("limits.periodDaily") }), react_jsx_runtime.jsx("option", { value: "monthly", children: translate("limits.periodMonthly") })] })
							] }),
							react_jsx_runtime.jsx("p", { className: S.note, children: translate("limits.amountSaveHint") }),
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									react_jsx_runtime.jsxs("div", {
										...
										react_jsx_runtime.jsx(primitives.Switch, {
											...
											disabled,
											label: translate("limits.enable"),
											title: translate("limits.enable"),
											onChange: (checked) => {
							...
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									react_jsx_runtime.jsxs("div", {
										...
										children: [
											react_jsx_runtime.jsx("span", { children: translate(period === "monthly" ? "limits.monthlyLimit" : "limits.dailyLimit") }),
									...
									children: react.createElement("input", {
											...
											key: `${targetKey}:${period}:${inputEpoch}:${limits === null ? "loading" : "ready"}`,
													disabled,
											placeholder: translate("limits.dailyLimitPlaceholder"),
											defaultValue: rule?.[spendField] ?? "",
											"aria-label": translate(period === "monthly" ? "limits.monthlyLimit" : "limits.dailyLimit"),
								onBlur: (event) => saveAmount(event, spendField),
											onKeyDown: (event) => {
								...
								children: [
									...
									react_jsx_runtime.jsxs("div", {
										...
										children: [
											...
											children: [
												react_jsx_runtime.jsx("span", { children: translate("limits.alertRange") }),
													react_jsx_runtime.jsx("span", { className: S.alertValue, children: `${alertPercent}% / ${criticalPercent}%` })
												]
											}),
											react_jsx_runtime.jsxs("div", {
												className: S.alertTrack,
											style: { "--alert-percent": `${alertPercent}%`, "--critical-percent": `${criticalPercent}%`, "--usg-range-low": "var(--usg-success)", "--usg-range-mid": "var(--usg-warning)", "--usg-range-high": "var(--usg-danger)" },
												children: [
											...
											react_jsx_runtime.jsxs("div", {
												...
												children: [
													react_jsx_runtime.jsx("span", { children: translate("limits.alertNormal", { percent: alertPercent }) }),
													react_jsx_runtime.jsx("span", { children: translate("limits.alertWarning", { percent: alertPercent, critical: criticalPercent }) }),
													react_jsx_runtime.jsx("span", { children: translate("limits.alertExceeded", { percent: criticalPercent }) })
												]
											})
										]
									})
							...
							react_jsx_runtime.jsxs("div", {
								...
								children: [
									...
									children: react.createElement("input", {
											...
											inputMode: "decimal",
											className: `${S.input} has_prefix`,
											key: `${targetKey}:balance:${inputEpoch}:${limits === null ? "loading" : "ready"}`,
													disabled,
											placeholder: translate("limits.lowBalancePlaceholder"),
											defaultValue: rule?.lowBalanceWarning ?? "",
											"aria-label": translate("limits.lowBalance"),
								onBlur: (event) => saveAmount(event, "lowBalanceWarning"),
											onKeyDown: (event) => {
												if (event.key === "Enter") event.currentTarget.blur();
											}
										})
							...
							react_jsx_runtime.jsx("h4", { className: S.limitSub, children: translate("limits.stopGroup") }),
							react_jsx_runtime.jsxs("label", { className: S.limitField, children: [
								react_jsx_runtime.jsx("span", { className: S.limitFieldLabel, children: translate("limits.minBalance") }),
								react.createElement("input", { type: "text", inputMode: "decimal", className: S.input, disabled,
									key: `${targetKey}:minimum:${inputEpoch}:${limits === null ? "loading" : "ready"}`,
									"aria-label": translate("limits.minBalance"), defaultValue: rule?.minBalance ?? "", placeholder: translate("limits.lowBalancePlaceholder"),
									onBlur: event => saveAmount(event, "minBalance"), onKeyDown: event => { if (event.key === "Enter") event.currentTarget.blur(); } })
							] }),
							react_jsx_runtime.jsxs("div", {
										className: S.limitFieldLabel,
										children: [
									...
									react_jsx_runtime.jsx(primitives.Switch, {
										...
										disabled,
										label: translate("limits.stopOnExceed"),
										title: translate("limits.stopOnExceed"),
										onChange: (nextValue) => {
		...
		function accountDisplayFields(display) {
			...
			if (display?.balance !== false) {
				fields.push(["todayCost", "accounts.showToday"]);
			}
			return fields;
		}
		...
		function AccountsCard({ keys, providers = [], defaultProviderId = "deepseek-official", onDefaultProviderUpdated, translate }) {
			...
			const accountSaveQueue = react.useRef(Promise.resolve());
			const accountSaveVersion = react.useRef(0);
			const [saveState, setSaveState] = react.useState("settings.autoSave");
			const [error, setError] = react.useState(null);
			const singleKey = (keys ?? []).length <= 1;
			const load = react.useCallback(() => {
				const version = accountSaveVersion.current;
				fetchJson("/api/usage-stats/accounts").then(value => {
					if (version === accountSaveVersion.current) setPayload(value);
				}).catch(() => {});
			}, []);
			...
			const savePatch = async (patch) => {
				const version = ++accountSaveVersion.current;
				setSaveState("limits.saving");
				setError(null);
				setPayload(current => current === null ? current : { ...current, settings: { ...current.settings, ...patch, display: { ...current.settings?.display, ...patch.display } } });
				try {
					const pending = accountSaveQueue.current.then(() => fetchJson("/api/usage-stats/accounts", { method: "POST", body: patch }));
					accountSaveQueue.current = pending.catch(() => {});
					const updated = await pending;
					if (updated.ok !== true) throw new Error(updated.message ?? "save failed");
					if (version === accountSaveVersion.current) {
						setError(null);
					...
					setError(err instanceof Error ? err.message : String(err));
					if (version === accountSaveVersion.current) { setSaveState("settings.unsaved"); load(); }
				}
			};
			...
			const statusLabelKey = (status) => {
				...
				return displayStatus === "ok" ? "balance.status.ok"
					...
					: displayStatus === "not-subscribed" ? "balance.status.subscriptionRequired"
						: displayStatus === "refresh-disabled" ? "balance.status.refreshDisabled"
			...
			return react_jsx_runtime.jsxs("section", {
				...
				children: [
					...
					react_jsx_runtime.jsx("p", { className: S.note, role: "status", children: translate(saveState) }),
					...
					displayedProviders.length > 0 ? displayedProviders.map((provider) => {
						...
						return react_jsx_runtime.jsxs("div", {
							...
							children: [
								react_jsx_runtime.jsxs("div", {
									...
									children: [
										react_jsx_runtime.jsx("span", { className: S.toggleTitle, children: provider.label }),
									provider.id === effectiveDefaultProviderId ? react_jsx_runtime.jsx(primitives.Tag, { tone: "success", children: translate("accounts.default") }) : null,
						...
						const balance = account?.balance ?? null;
						const tone = account?.status === "ok" ? "ok" : account?.status === "not-configured" || account?.status === "pending" || account?.status === "refresh-disabled" ? "muted" : "bad";
						return react_jsx_runtime.jsxs("div", {
							className: S.row,
							children: [
								react_jsx_runtime.jsxs("div", {
									...
									children: [
										...
										key.default ? react_jsx_runtime.jsx(primitives.Tag, { tone: "success", children: translate("accounts.default") }) : null,
										!key.configured ? react_jsx_runtime.jsx(primitives.Tag, { tone: "warning", children: translate("balance.unconfigured") }) : null
									]
								}),
								react_jsx_runtime.jsxs("div", {
									className: S.toggleInfo,
							...
							accountDisplayFields(display).map(([field, labelKey]) => react_jsx_runtime.jsxs("div", {
								...
								children: [
									...
									react_jsx_runtime.jsx(primitives.Switch, {
										...
										onChange: (checked) => savePatch({ display: { [field]: checked } })
									})
								]
							}, field))
							]
		...
		function PricingCard({ translate, onPricingUpdated }) {
			...
			const [draftBase, setDraftBase] = react.useState(null);
			...
			const handleFork = () => {
				...
				setDraft(draftOf(editableModels));
			};
			...
			const handleSaveCustom = async () => {
				...
				try {
					...
					const result = await fetchJson("/api/usage-stats/pricing", { method: "POST", body: { mode: "custom", pricing: pricingWritePayload(draftBase ?? current, currency, numeric.models) } });
				...
				children: [
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							...
							react_jsx_runtime.jsx(primitives.Tag, { tone: usingCustom ? "warning" : "success", children: usingCustom ? translate("pricing.custom") : translate("pricing.official") })
						]
					}),
					...
					draft !== null && react_jsx_runtime.jsx("p", { className: S.note, children: translate("settings.manualSave") }),
					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							draft !== null ? react_jsx_runtime.jsx("button", {
								...
								children: translate(saving ? "limits.saving" : "pricing.saveCustom")
							}) : react_jsx_runtime.jsx("button", {
								type: "button",
								className: S.btn,
								disabled: saving || fetchingOfficial,
							...
							draft !== null ? react_jsx_runtime.jsx("button", {
								...
								disabled: saving || fetchingOfficial,
								onClick: () => { setDraft(null); setDraftBase(null); },
					...
					officialPreview !== null && react_jsx_runtime.jsx(primitives.Modal, {
						...
						title: translate("pricing.confirmOfficialTitle"),
						...
						children: react_jsx_runtime.jsxs("div", {
							...
							children: [
								...
								Array.isArray(officialPreview.routes) && officialPreview.routes.length > 0 ? react_jsx_runtime.jsxs("div", {
									"data-usage-official-pricing-routes": true,
									children: [
										react_jsx_runtime.jsx("p", { className: S.note, children: translate("pricing.routesTitle") }),
										react_jsx_runtime.jsx("ul", { className: S.note, children: officialPreview.routes.map((route, index) => react_jsx_runtime.jsx("li", {
											children: translate("pricing.route", {
												model: route.model,
												priceModel: route.priceModel,
												time: new Date(route.effectiveFrom).toLocaleString()
											})
										}, `${route.model}-${route.effectiveFrom}-${index}`)) })
									]
								}) : null,
		...
		function PlanQuotaCard({ translate, windows = ["five_hour", "weekly"] }) {
			const planSaveQueue = react.useRef(Promise.resolve());
			const planSaveVersion = react.useRef(0);
			const [policy, setPolicy] = react.useState(null);
			const [error, setError] = react.useState(null);
			const planQuotaRef = react.useRef(null);
			const load = react.useCallback((publish = false) => {
				const version = planSaveVersion.current;
				fetchJson("/api/usage-stats/alerts").then((payload) => {
					if (version !== planSaveVersion.current) return;
					const nextPolicy = payload.notifications ?? {};
					planQuotaRef.current = nextPolicy.planQuota ?? null;
					if (publish && planQuotaRef.current !== null) publishPlanQuota(planQuotaRef.current);
			...
			const quotaWindowsOf = (candidate) => ({
				...
				monthly: { warningRemainingPercent: candidate.windows?.monthly?.warningRemainingPercent ?? candidate.warningRemainingPercent ?? 30, criticalRemainingPercent: candidate.windows?.monthly?.criticalRemainingPercent ?? candidate.criticalRemainingPercent ?? 10 }
			});
			...
			const savePolicy = async (patch) => {
				...
				setError(null);
				try {
					const pending = planSaveQueue.current.then(() => fetchJson("/api/usage-stats/alerts", { method: "POST", body: { notifications: patch } }));
					planSaveQueue.current = pending.catch(() => {});
					const updated = await pending;
					if (updated.ok !== true) throw new Error(updated.message ?? "save failed");
					if (version !== planSaveVersion.current) return;
					setError(null);
					...
					setError(err instanceof Error ? err.message : String(err));
					if (version === planSaveVersion.current) load(true);
				}
			};
			const savePlanQuotaThreshold = (windowKind, field, rawValue) => {
				...
				savePolicy({ planQuota: { windows: { [windowKind]: next } } });
			};
			const updatePlanQuotaLocal = (windowKind, field, rawValue) => {
				planSaveVersion.current++;
				const value = Math.max(0, Math.min(100, Math.round(Number(rawValue) || 0)));
				const basePlanQuota = planQuotaRef.current ?? planQuota;
				const baseWindows = quotaWindowsOf(basePlanQuota);
				const next = { ...baseWindows[windowKind], [field]: value };
			...
			return react_jsx_runtime.jsxs("div", {
				...
				children: [
					error !== null ? react_jsx_runtime.jsx("div", { className: S.error, children: translate("notifications.saveError", { message: error }) }) : null,
						...
						...windows.filter(kind => ["five_hour", "weekly", "monthly"].includes(kind)).map(kind => renderPlanQuotaWindow(kind, kind === "five_hour" ? "limits.planQuotaFiveHour" : kind === "weekly" ? "limits.planQuotaWeekly" : "limits.planQuotaMonthly"))
				]
			});
		}

		/** Keep settings controls hidden until their persisted state is available. */
		function SettingsReadState({ title, description, marker, loading, error, retry, translate }) {
			return react_jsx_runtime.jsxs("section", { className: S.card, [marker]: true, "aria-busy": loading, children: [
				react_jsx_runtime.jsx("span", { className: S.cardTitle, children: translate(title) }),
				react_jsx_runtime.jsx("p", { className: S.note, children: translate(description) }),
				error === null ? react_jsx_runtime.jsx("p", { className: S.note, role: "status", children: translate("usage.loading") })
					: react_jsx_runtime.jsxs("div", { className: S.error, role: "alert", children: [
						react_jsx_runtime.jsx("span", { children: translate("usage.error", { message: error }) }),
						react_jsx_runtime.jsx("button", { type: "button", className: S.retry, disabled: loading, onClick: retry, children: translate("action.retry") })
					] })
			] });
		}
		...
		function NotificationsCard({ translate }) {
			...
			const load = react.useCallback(() => {
				...
				setLoading(true);
				return fetchJson("/api/usage-stats/alerts").then((payload) => {
				...
				}).finally(() => { if (version === saveVersion.current) setLoading(false); });
			}, []);
			react.useEffect(() => { load(); }, [load]);
			...
			const savePolicy = async (patch) => {
				...
				setSaveState("limits.saving");
				setError(null);
				setPolicy(current => ({ ...current, ...patch, channels: { ...current?.channels, ...patch.channels }, events: { ...current?.events, ...patch.events } }));
				try {
					const pending = saveQueue.current.then(() => fetchJson("/api/usage-stats/alerts", { method: "POST", body: { notifications: patch } }));
					...
					if (version === saveVersion.current) {
						...
						setSaveState("settings.saved");
						setPolicy(updated.notifications);
						window.dispatchEvent(new window.CustomEvent("usage-stats:notifications-updated", { detail: { notifications: updated.notifications } }));
					}
				} catch (err) {
					setError(err instanceof Error ? err.message : String(err));
					if (version === saveVersion.current) { setSaveState("settings.unsaved"); load(); }
				}
			};
			if (policy === null || loadError !== null) return react_jsx_runtime.jsx(SettingsReadState, {
				title: "notifications.title", description: "notifications.desc", marker: "data-usage-notifications-card", loading, error: loadError, retry: load, translate
			});
			return react_jsx_runtime.jsxs("section", {
				className: S.card,
							...
							[["sidebar", "notifications.channelSidebar"], ["toast", "notifications.channelToast"]].map(([field, labelKey]) => react_jsx_runtime.jsxs("div", {
								...
								children: [
									...
									react_jsx_runtime.jsx(primitives.Switch, {
										...
										label: translate(labelKey),
										title: translate(labelKey),
										onChange: (checked) => savePolicy({ channels: { [field]: checked } })
									})
								]
							}, field))
						]
							...
							[["warning", "notifications.eventWarning"], ["exceeded", "notifications.eventExceeded"], ["lowBalance", "notifications.eventLowBalance"], ["recovery", "notifications.eventRecovery"]].map(([field, labelKey]) => react_jsx_runtime.jsxs("div", {
								...
								children: [
									...
									react_jsx_runtime.jsx(primitives.Switch, {
										...
										label: translate(labelKey),
										title: translate(labelKey),
										onChange: (checked) => savePolicy({ events: { [field]: checked } })
									})
								]
							}, field))
						]
								...
								children: alerts.length === 0
									...
									: alerts.map((item, index) => react_jsx_runtime.jsxs("div", {
										...
										children: [
											...
											react_jsx_runtime.jsx(primitives.Tag, { tone: item.type === "recovery" ? "success" : "danger", children: item.type === "recovery" ? translate("notifications.type.recovery") : translate("notifications.type.alert") })
												]
											}),
		...
		function DataCard({ translate }) {
			...
			const load = react.useCallback(() => {
				setLoading(true);
				return fetchJson("/api/usage-stats/data").then((payload) => {
			...
			const run = async (action, extra = {}) => {
				...
				try {
					...
					if (action === "clear") setResult({ key: "data.cleared" });
					else if (action === "rebuild" || action === "rebuild-estimated") {
						const skipped = Number(payload.preview?.unreadableSessions);
						setResult(Number.isSafeInteger(skipped) && skipped > 0
							? { key: "data.rebuildSkipped", params: { count: skipped } }
							: { key: "data.rebuilt" });
					} else setResult({ key: "data.trimmed" });
					await load();
				} catch (err) {
					setError(err instanceof Error ? err.message : String(err));
				} finally {
			...
			const saveLedgerCapacity = async () => {
				...
				try {
					...
					if (payload.ok !== true) throw new Error(payload.message ?? "save failed");
					setResult({ key: "data.capacitySaved" });
					await load();
				} catch (err) {
					setError(err instanceof Error ? err.message : String(err));
				} finally {
			...
			if (info === null || loadError !== null) return react_jsx_runtime.jsx(SettingsReadState, {
				title: "data.title", description: "data.desc", marker: "data-usage-data-card", loading, error: loadError, retry: load, translate
			});
			return react_jsx_runtime.jsxs("section", {
				className: S.card,
				...
				children: [
					...
					result !== null && react_jsx_runtime.jsx("p", { className: S.hint, children: result.params === void 0 ? translate(result.key) : interpolate(translate(result.key), result.params) }),
					...
					react_jsx_runtime.jsxs("div", {
						...
						"data-usage-rebuild-panel": true,
						children: [
							react_jsx_runtime.jsxs("div", { className: S.dataActionInfo, children: [
								react_jsx_runtime.jsx("span", { className: S.toggleTitle, children: translate("data.rebuildTitle") }),
								react_jsx_runtime.jsx("p", { className: S.note, children: translate("data.rebuildNote") })
							] }),
							react_jsx_runtime.jsx("div", { className: S.dataActionControls, children: (
								react_jsx_runtime.jsx("button", {
									type: "button",
									className: S.btn,
									disabled: busy,
									onClick: () => run("rebuild-estimated"),
						...
						children: react_jsx_runtime.jsxs("div", {
							...
							children: [
								...
								react_jsx_runtime.jsx("input", {
									type: "text",
									className: S.input,
									"data-usage-clear-confirmation": true,
		...
		function navigateTabs(event, ids, select) {
		...
		function UsageBillingSettingsSection({ t }) {
			...
			const [visitedTabs, setVisitedTabs] = react.useState(["accounts"]);
			const [billingProviderId, setBillingProviderId] = react.useState(null);
			const tabsId = react.useId();
			const selectTab = id => { setActiveTab(id); setVisitedTabs(current => current.includes(id) ? current : [...current, id]); };
			const requestedBillingProviderId = billingProviderId ?? defaultProviderId;
			const effectiveBillingProviderId = providers.some((provider) => provider.id === requestedBillingProviderId)
				? requestedBillingProviderId
			...
			return react_jsx_runtime.jsxs("div", {
				...
				children: [
					...
					react_jsx_runtime.jsxs("div", {
						...
						onKeyDown: event => navigateTabs(event, SETTINGS_TABS.map(tab => tab.id), selectTab),
					...
					...SETTINGS_TABS.filter(tab => visitedTabs.includes(tab.id)).map(tab => react_jsx_runtime.jsx("div", {
						role: "tabpanel", id: `${tabsId}-panel-${tab.id}`, "aria-labelledby": `${tabsId}-tab-${tab.id}`,
						hidden: activeTab !== tab.id, style: activeTab !== tab.id ? { display: "none" } : void 0,
						children: tab.id === "accounts" ? react_jsx_runtime.jsx(AccountsCard, { keys, providers, defaultProviderId, onDefaultProviderUpdated: setDefaultProviderId, translate })
						: tab.id === "limits" ? (loaded === false ? react_jsx_runtime.jsx("p", { className: S.note, children: translate("usage.loading") }) : react_jsx_runtime.jsxs("div", {
							className: S.section,
							"data-usage-provider-billing-settings": true,
							children: [
								react_jsx_runtime.jsxs("label", { className: S.row, children: [
									react_jsx_runtime.jsx("span", { className: S.rowLabel, children: translate("settings.editProvider") }),
									react_jsx_runtime.jsx("select", { className: S.select, "aria-label": translate("settings.editProvider"), value: effectiveBillingProviderId,
										onChange: event => setBillingProviderId(event.target.value),
										children: providers.map(provider => react_jsx_runtime.jsx("option", { value: provider.id, children: provider.label ?? provider.id }, provider.id)) })
								] }),
								react_jsx_runtime.jsx(LimitsCard, {
							keys,
							selectedKey,
							onSelectKey: setSelectedKey,
							pricing,
						...
						}), react_jsx_runtime.jsx("div", { hidden: effectiveBillingProviderId !== "deepseek-official" || billingProviderKind !== "balance", children: react_jsx_runtime.jsx(PricingCard, { translate, onPricingUpdated: () => loadUsage() }) })]
						}))
						: tab.id === "notifications" ? react_jsx_runtime.jsx(NotificationsCard, { translate })
		...
		const SIDEBAR_USAGE_REVISION_POLL_MS = 1000;
		/** Host Toast hold: its native one-second fade keeps the total at five seconds. */
		const USAGE_TOAST_HOLD_MS = 4000;
		...
		/** Native Harness sidebar action that owns the legacy modal fallback. */
		function UsageStatsPanel({ wide, t, openInHostSurface }) {
			...
			const panelBodyRef = react.useRef(null);
			const summaryRequestRef = react.useRef(0);
			const summaryContextRef = react.useRef(null);
			const usageRevisionRef = react.useRef(null);
			const revisionRequestPendingRef = react.useRef(false);
			...
			const loadSummary = react.useCallback(() => {
				...
				Promise.allSettled([
					...
					return Promise.allSettled([
						...
						fetchJson(`/api/usage-stats/balance${providerQuery}${providerQuery ? "&" : "?"}auto=1`)
						...
						const limitsPayload = limitsResult.status === "fulfilled" ? limitsResult.value : null;
						if (Number.isInteger(usagePayload?.revision)) usageRevisionRef.current = usagePayload.revision;
						summaryContextRef.current = { providerId, provider, balancePayload, limitsPayload };
			...
			const checkUsageRevision = react.useCallback(() => {
				if (document.visibilityState === "hidden" || revisionRequestPendingRef.current) return;
				revisionRequestPendingRef.current = true;
				fetchJson("/api/usage-stats/usage-revision").then((revisionPayload) => {
					const nextRevision = revisionPayload?.revision;
					if (!Number.isInteger(nextRevision) || nextRevision === usageRevisionRef.current) return;
					const context = summaryContextRef.current;
					if (context === null) return;
					const providerQuery = context.providerId ? `?provider=${encodeURIComponent(context.providerId)}` : "";
					return Promise.allSettled([
						fetchJson(`/api/usage-stats/usage${providerQuery}`),
						fetchJson(`/api/usage-stats/balance${providerQuery}${providerQuery ? "&" : "?"}auto=1`),
						fetchJson("/api/usage-stats/limits"),
						fetchJson("/api/usage-stats/alerts")
					]).then(([usageResult, balanceResult, limitsResult, alertsResult]) => {
						if (summaryContextRef.current !== context || usageResult.status !== "fulfilled") return;
						const usagePayload = filterUsageByProvider(usageResult.value, context.providerId);
						if (usagePayload?.ok !== true) return;
						const balancePayload = balanceResult.status === "fulfilled" ? balanceResult.value : context.balancePayload;
						const limitsPayload = limitsResult.status === "fulfilled" ? limitsResult.value : context.limitsPayload;
						usageRevisionRef.current = Number.isInteger(usagePayload.revision) ? usagePayload.revision : nextRevision;
						summaryContextRef.current = { ...context, balancePayload, limitsPayload };
						if (alertsResult.status === "fulfilled") deliverAlerts(alertsResult.value, context.providerId);
						setSummary(sidebarSummaryOf(usagePayload, balancePayload, limitsPayload, undefined, context.providerId, context.provider?.label ?? context.providerId, context.provider));
					});
				}).catch(() => {}).finally(() => {
					revisionRequestPendingRef.current = false;
				});
			}, [deliverAlerts]);
			const showBalance = display.balance !== false;
			const showToday = display.todayCost !== false;
			// The server projects legacy display.statusDot into this single setting.
			const showStatusDot = notifications.channels?.sidebar !== false;
			...
			const accountStatusSummary = summary.accountStatus === "not-subscribed" ? t("balance.status.subscriptionRequired")
				: summary.accountStatus === "not-configured" ? t("balance.status.notConfigured")
					: summary.accountStatus === "refresh-disabled" ? t("balance.status.refreshDisabled")
						...
						: summary.accountStatus === "rate-limited" ? t("balance.status.rateLimited")
							: summary.accountStatus === "unavailable" ? t("balance.status.unavailable")
								: summary.accountStatus === "unsupported" ? t("balance.status.unsupported")
									: summary.accountStatus === "error" ? t("balance.status.error")
									: null;
			const primarySummary = summary.kind === "plan_quota"
				? accountStatusSummary ?? (planWindowText || `${windowLabel}${summary.primaryWindowPercent === null ? "" : ` ${summary.primaryWindowPercent.toFixed(0)}%`}`)
				: summary.kind === "local_usage"
					...
					: accountStatusSummary ?? `${summary.balance}`;
					...
					react_jsx_runtime.jsxs("span", {
						...
						children: [
							react_jsx_runtime.jsx("span", {
								...
								children: showStatusDot ? react_jsx_runtime.jsx("span", { "data-usage-plan-status-dot": true, children: react_jsx_runtime.jsx(primitives.StateDot, { state: hostDotState(item.tone), size: 10 }) }) : null
							}),
							item.text
						]
					}, item.kind)
			...
			const showTodaySummary = showToday && summary.todayVisible === true;
			const summaryText = [
			...
			react.useEffect(() => {
				...
				const onNotificationsUpdated = event => {
					...
					if (event.detail?.notifications?.channels?.toast === false) setToasts([]);
					loadSummary();
				};
				window.addEventListener("usage-stats:notifications-updated", onNotificationsUpdated);
				window.addEventListener("usage-stats:plan-quota-updated", onPlanQuotaUpdated);
				return () => {
					window.clearInterval(timer);
					window.removeEventListener("usage-stats:limits-updated", onLimitsUpdated);
					window.removeEventListener("usage-stats:accounts-updated", onAccountsUpdated);
					window.removeEventListener("usage-stats:notifications-updated", onNotificationsUpdated);
			...
			react.useEffect(() => {
				const onVisibilityChange = () => {
					if (document.visibilityState !== "hidden") checkUsageRevision();
				};
				const timer = window.setInterval(checkUsageRevision, SIDEBAR_USAGE_REVISION_POLL_MS);
			...
			const closePanel = react.useCallback(() => {
				setOpen(false);
				layerRef.current?.querySelector("[data-usage-stats-trigger]")?.focus();
			}, []);
			react.useEffect(() => {
				if (open) panelBodyRef.current?.querySelector("[data-usage-stats-close]")?.focus();
			}, [open]);
			...
			return react_jsx_runtime.jsxs("div", {
				...
				children: [
					open && react_jsx_runtime.jsx(primitives.Modal, {
						open: true,
						headless: true,
						title: t("panel.title"),
						onClose: closePanel,
					...
					react_jsx_runtime.jsx("div", {
						...
						children: react_jsx_runtime.jsxs("button", {
							...
							onClick: () => {
								if (!open && openInHostSurface?.()) return;
								setOpen((value) => !value);
							},
						children: [
								...
								wide && react_jsx_runtime.jsxs("span", {
									...
									children: [
										...
										showStatusDot && summary.balanceStatus !== "muted" ? react_jsx_runtime.jsx(primitives.StateDot, { state: hostDotState(summary.balanceStatus), size: 10 }) : null,
											primarySummaryNode
										] }) : null,
										showBalance && showTodaySummary ? " · " : null,
										showTodaySummary ? react_jsx_runtime.jsxs("span", { className: S.statusItem, children: [
										showStatusDot && summary.todayStatus !== "muted" ? react_jsx_runtime.jsx(primitives.StateDot, { state: hostDotState(summary.todayStatus), size: 10 }) : null,
											todaySummaryNode
										] }) : null
								]
								})
					...
					// deliverAlerts 标记为已读；新告警复用宿主 Toast，保持 5 秒总生命周期。
					toasts.map((toast) => react_jsx_runtime.jsx(primitives.Toast, {
						key: toast.key,
						text: toast.text,
						holdMs: USAGE_TOAST_HOLD_MS,
		...
		const NS = "usageStats";
		const zh = {
			"settings.editProvider": "正在编辑的供应商",
			"settings.saved": "已保存",
			"settings.autoSave": "更改后自动保存",
			"settings.unsaved": "未保存",
			"settings.manualSave": "修改价格后点击保存；切换页签会保留当前草稿。",
			"limits.period": "消费限额周期",
			"limits.periodDaily": "每日",
			"limits.periodMonthly": "每月",
			"limits.monthlyLimit": "每月消费限额",
			"limits.monthlyLimitStatus": "本月消费限额",
			"limits.monthlyProgress": "本月已消费 {spent} / 限额 {limit} ({percent}%)",
			"limits.amountSaveHint": "金额失焦或按 Enter 后保存；留空表示不限。未启用时只保存配置，不执行提醒或拦截。",
			"limits.invalidAmount": "请输入大于 0 的有效金额，或留空取消限额。当前输入尚未保存。",
			"limits.stopGroup": "达到限额后的行为",
			"limits.minBalance": "最低余额（停止新调用）",
			"limits.planQuotaMonthly": "每月",
			"nav": "用量统计",
			"panel.title": "用量与余额",
			"panel.badge": "用量/余额",
			"panel.sidebarDescription": "在侧栏持续查看账户状态、Token 与费用趋势。",
			"panel.balance": "余额",
			"panel.today": "今日",
			...
			"panel.tabDetails": "明细",
			"workspace.title": "工作区 Token 分布",
			"workspace.reportMeta": "{tokens} tokens · {workspaces} 个工作区 · {sessions} 个会话",
			"workspace.range": "统计范围",
			"workspace.rangeAll": "全部",
			"workspace.customRange": "自定义",
			"workspace.from": "开始日期",
			"workspace.to": "结束日期",
			"workspace.total": "合计 Token",
			"workspace.workspaceCount": "工作区",
			"workspace.sessionCount": "会话",
			"workspace.unknown": "未标注工作区",
			"workspace.unknownSession": "未标注会话",
			"workspace.sessions": "{count} 个会话",
			"workspace.empty": "该时间范围内没有用量记录",
			"workspace.loading": "正在统计工作区…",
			"workspace.error": "工作区统计加载失败：{message}",
			"workspace.estimatedNote": "历史工作区数据来自会话日志重建；未重建前的历史可能不完整。",
			"action.refresh": "刷新",
			"action.retry": "重试",
			"action.close": "关闭",
			"action.today": "回到今天",
			...
			"action.prevDay": "上一有数据日",
			"action.nextDay": "下一有数据日",
			...
			"balance.status.refreshDisabled": "自动刷新已关闭",
			...
			"usage.model": "模型",
			"usage.allModels": "全部已用模型",
			"usage.modelUsage": "模型用量",
			"usage.modelTrend": "多模型趋势",
			"usage.modelTrendHourly": "TOP 5 · 按小时",
			"usage.modelTrendDaily": "TOP 5 · 按天",
			"usage.noModelUsage": "暂无模型用量",
			"usage.requestCount": "请求次数",
				"usage.activityToday": "今日 Token",
				"usage.activityAllProviders": "全局今日 Token",
				"usage.activityRange": "{range} Token",
				"usage.activityRangeAllProviders": "全局{range} Token",
			...
			"usage.rangeLastMonth": "上月",
				...
				"usage.costRange": "{range}消费(估算)",
				"usage.costRangeUnpriced": "{range}消费(部分未定价)",
				"usage.activeModelFilter": "模型：{model}",
				"usage.clearModelFilter": "清除模型筛选：{model}",
				"usage.selectedDay": "当前明细日期",
			...
			"usage.error": "用量统计失败：{message}",
				"usage.hourly": "按小时统计",
				"usage.daily": "按天统计",
			"usage.globalTimeline": "全局用量时序",
			"usage.heatmap": "{year} 年每日用量",
			"usage.year": "选择年份",
			"usage.legendLess": "少",
			"usage.legendMore": "多",
			"usage.recent": "最近 14 天",
			"usage.detailsTitle": "近期用量明细",
			"usage.detailsDesc": "按日期查看 Token 与费用，点击记录进入对应日期概览",
			"usage.detailsDescAllProviders": "查看全部供应商的 Token 与费用，按模型筛选或点击日期进入概览",
			"usage.detailsDays": "{count} 天记录",
			...
			"limits.providerSwitchDesc": "只编辑上方选中的供应商，不改变侧栏默认展示或模型调用路由。",
			"limits.planQuotaTitle": "套餐额度预警",
			"limits.planQuotaDesc": "以下为所有套餐供应商共用的剩余额度阈值，仅显示当前供应商支持的窗口；同类窗口同步生效，不修改真实套餐额度。",
			...
			"limits.enableDesc": "启用消费与余额阈值判断；是否停止新调用由下方独立设置。",
			...
			"limits.alertPercent": "已用额度预警比例",
			"limits.alertRange": "预警线与严重线",
			...
			"limits.stopDesc": "开启提醒和此开关后，消费达到限额的 100% 或余额不高于最低余额时停止新调用。余额提醒本身不触发停止；金额不可靠或余额过期时相应检查放行。",
			...
			"settings.desc": "在这里管理账户展示、计费与限额、通知和本地数据。余额与用量图表可在侧栏查看。",
			...
			"accounts.desc": "只显示模型设置中已添加的供应商。默认展示供应商会同步用于侧栏和查询浮层。",
			"accounts.defaultProvider": "侧栏默认供应商",
			"accounts.defaultProviderDesc": "设置侧栏及用量面板默认展示的供应商；不改变计费页的编辑选择或模型调用供应商。",
			...
			"accounts.refreshDesc": "控制自动查询远程余额或套餐的间隔；关闭后自动读取仅显示缓存，可手动刷新。模型调用前必要的余额保障检查仍会执行。",
			...
			"pricing.routesTitle": "同时应用以下按时间生效的计费型号映射：",
			"pricing.route": "{model} → {priceModel}，自 {time} 起",
			...
			"data.cleared": "历史已清除",
			"data.rebuilt": "统计已刷新",
			"data.rebuildSkipped": "统计已刷新；{count} 个会话由更新版本的 Harness 写入、无法解读，已跳过",
			"data.rebuildTitle": "历史估算重建",
			"data.rebuildNote": "从会话日志重建每天首次记账之前的历史估算。当天开始记账后因停用或写入失败遗漏的用量无法自动补回；无法解读的会话将跳过。",
			"data.rebuild": "重建估算",
		...
		const en = {
			"settings.editProvider": "Provider to edit",
			"settings.saved": "Saved",
			"settings.autoSave": "Changes save automatically",
			"settings.unsaved": "Not saved",
			"settings.manualSave": "Save after editing prices; switching tabs keeps the current draft.",
			"limits.period": "Spend limit period",
			"limits.periodDaily": "Daily",
			"limits.periodMonthly": "Monthly",
			"limits.monthlyLimit": "Monthly spend limit",
			"limits.monthlyLimitStatus": "Monthly spend limit",
			"limits.monthlyProgress": "Month spent {spent} / limit {limit} ({percent}%)",
			"limits.amountSaveHint": "Amounts save on blur or Enter; leave blank for no limit. Disabled rules retain settings without alerts or blocking.",
			"limits.invalidAmount": "Enter a valid amount greater than 0, or leave blank for no limit. This input has not been saved.",
			"limits.stopGroup": "When a limit is reached",
			"limits.minBalance": "Minimum balance (stop new calls)",
			"limits.planQuotaMonthly": "Monthly",
			"nav": "Usage Stats",
			"panel.title": "Usage & Balance",
			"panel.badge": "Usage/Balance",
			"panel.sidebarDescription": "Keep account status, tokens, and cost trends visible in the sidebar.",
			...
			"workspace.title": "Token distribution by workspace",
			"workspace.reportMeta": "{tokens} tokens · {workspaces} workspaces · {sessions} sessions",
			"workspace.range": "Range",
			"workspace.rangeAll": "All",
			"workspace.customRange": "Custom",
			"workspace.from": "Start date",
			"workspace.to": "End date",
			"workspace.total": "Total tokens",
			"workspace.workspaceCount": "Workspaces",
			"workspace.sessionCount": "Sessions",
			"workspace.unknown": "Unlabeled workspace",
			"workspace.unknownSession": "Unlabeled session",
			"workspace.sessions": "{count} sessions",
			"workspace.empty": "No usage in this range",
			"workspace.loading": "Loading workspace usage…",
			"workspace.error": "Failed to load workspace usage: {message}",
			"workspace.estimatedNote": "Historical workspace data comes from session-log rebuilds; history may be incomplete until a rebuild.",
			...
			"action.prevDay": "Previous day with usage",
			"action.nextDay": "Next day with usage",
			...
			"balance.status.refreshDisabled": "Automatic refresh is off",
			...
			"usage.model": "Model",
			"usage.allModels": "All used models",
			"usage.modelUsage": "Model usage",
			"usage.modelTrend": "Multi-model trend",
			"usage.modelTrendHourly": "TOP 5 · hourly",
			"usage.modelTrendDaily": "TOP 5 · daily",
			"usage.noModelUsage": "No model usage",
			"usage.requestCount": "Requests",
				"usage.activityToday": "Tokens today",
				"usage.activityAllProviders": "Global tokens today",
				"usage.activityRange": "Tokens · {range}",
				"usage.activityRangeAllProviders": "Global tokens · {range}",
			"usage.tokenUnit": "tokens",
			"usage.today": "Today",
			...
			"usage.rangeLastMonth": "Last month",
				...
				"usage.costRange": "Spend · {range} (est.)",
				"usage.costRangeUnpriced": "Spend · {range} (some unpriced)",
				"usage.activeModelFilter": "Model: {model}",
				"usage.clearModelFilter": "Clear model filter: {model}",
				"usage.selectedDay": "Detail date",
			...
			"usage.globalTimeline": "Global usage timeline",
			...
			"usage.detailsTitle": "Recent usage details",
			"usage.detailsDesc": "Review tokens and cost by date, then open a day for its overview",
			"usage.detailsDescAllProviders": "Review tokens and cost across all providers, filter by model, or open a day in Overview",
			"usage.detailsDays": "{count} days",
			...
			"limits.providerSwitchDesc": "Edits apply to the provider selected above, without changing the sidebar default or model routing.",
			"limits.planQuotaTitle": "Plan quota alerts",
			"limits.planQuotaDesc": "These remaining-quota thresholds are shared by all plan providers. Only windows supported by the selected provider are shown; matching windows share thresholds without changing the actual plan.",
			...
			"limits.enableDesc": "Enable spend and balance thresholds; stopping new calls is configured separately below.",
			...
			"limits.alertPercent": "Spent quota thresholds",
			"limits.alertRange": "Warning and critical lines",
			...
			"limits.stopDesc": "When thresholds and this switch are enabled, stop new calls at 100% of the spend cap or at/below the minimum balance. Balance warnings alone do not stop calls; unreliable costs or stale balances skip their respective checks.",
			...
			"settings.desc": "Manage account display, billing limits, notifications and local data here. View balances and usage charts from the sidebar.",
			...
			"accounts.desc": "Only providers added in Model settings are shown. The default display provider is also used by the sidebar and query panel.",
			"accounts.defaultProvider": "Sidebar default provider",
			"accounts.defaultProviderDesc": "Set the default provider shown in the sidebar and usage panel, without changing the billing editor selection or model routing.",
			...
			"accounts.refreshDesc": "Control automatic balance and plan queries. When off, automatic reads use cached data; manual refresh remains available. Required balance safeguards before model calls still run.",
			...
			"pricing.routesTitle": "The following time-versioned billing model routes will also apply:",
			"pricing.route": "{model} → {priceModel}, effective {time}",
			...
			"notifications.desc": "Configure shared alert channels, events and cooldowns. Plan color thresholds are configured on the billing tab.",
			...
			"notifications.channelSidebarDesc": "Show sidebar status dots when the provider summary is enabled.",
			...
			"data.rebuildSkipped": "Stats recomputed; {count} session(s) written by a newer Harness build could not be read and were skipped",
			"data.rebuildTitle": "Estimated history rebuild",
			"data.rebuildNote": "Rebuild estimated history before each day's first recorded call. Gaps after recording began, including disabled collection or failed writes, cannot be recovered automatically. Unreadable sessions are skipped.",
			"data.rebuild": "Rebuild estimates",
		...
		/**
		 * Client plugin body: register dictionaries, the sidebar footer action,
		 * settings, and the latest host's optional right-Sidebar/global panels.
		...
		function apply(ctx) {
			...
			ctx.slots.inject("sidebar.footer.action", () => ctx.slots.register({
				...
				locale: NS,
				inject: () => ({
					openInHostSurface: () => openUsageStatsInHostSurface(ctx)
				})
			}, UsageStatsPanel));
			...
			if (typeof ctx.inject === "function") ctx.inject(["sidebarRight", "sidebarRightTabs"], (scope) => {
				scope.effect(() => scope.sidebarRightTabs.register({
					id: USAGE_STATS_TAB_ID,
					kind: USAGE_STATS_TAB_KIND,
					priority: "extension",
					title: () => t("panel.title"),
					guide: [{
						order: 60,
						title: () => t("panel.title"),
						description: () => t("panel.sidebarDescription"),
						icon: UsageCurrencyIcon
					}]
				}), "usage-stats: right-Sidebar tab type");
				scope.slots.inject("sidebar.right.pane.tab", () => scope.slots.register({
					name: "sidebar.right.pane.tab",
					key: USAGE_STATS_TAB_ID,
					locale: NS
				}, UsageStatsRightSidebar));
			});
			if (typeof ctx.inject === "function") ctx.inject(["layout"], (scope) => {
				scope.slots.inject("main", () => scope.slots.register({
					name: "main",
					key: USAGE_STATS_MAIN_PANEL_ID,
					locale: NS,
					inject: () => ({
						closePanel: () => scope.layout.selectPanel(null)
					})
				}, UsageStatsMainPanel));
			});
		}
		...
		exports.UsageStatsRightSidebar = UsageStatsRightSidebar;
		exports.UsageStatsMainPanel = UsageStatsMainPanel;
		...
		exports.pointerTooltipStyle = pointerTooltipStyle;
		exports.freshAlertsForProvider = freshAlertsForProvider;
		exports.pricingWritePayload = pricingWritePayload;
		exports.WorkspaceUsageView = WorkspaceUsageView;
		exports.workspaceRangeWindow = workspaceRangeWindow;
		exports.workspaceLabelOf = workspaceLabelOf;
		exports.sessionLabelOf = sessionLabelOf;
