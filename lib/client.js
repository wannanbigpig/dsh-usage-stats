								...
								children: [
									...
									translate("balance.apiKey")
											...
											react_jsx_runtime.jsx("select", {
												...
												onChange: (e) => { setTimeRange(e.target.value); if (e.target.value !== "custom") setSelectedDay(null); },
												children: timeRangeOptions.map((opt) => react_jsx_runtime.jsx("option", { value: opt.value, children: opt.label }, opt.value))
											})
										]
									}),
									singleRange ? react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, { children: [
										activeDay === null
											? react_jsx_runtime.jsx("p", { className: S.note, children: translate("chart.empty") })
											: react_jsx_runtime.jsx(HourlyChart, { day: activeDay, peakHours: pricing.peakHours, money, translate }),
							...
							react_jsx_runtime.jsxs("section", {
								...
								children: [
									...
									react_jsx_runtime.jsx(DayList, {
										...
										onSelect: (date) => { setSelectedDay(date === (serverToday ?? todayKey()) ? null : date); setTimeRange(date === (serverToday ?? todayKey()) ? "today" : "custom"); },
										money,
										translate
									})
								]
