...
assert.equal(packageJson.version, "0.5.0", "monthly limits, independent supplier selection, host alpha.1 seam adaptations, and pricing review release as the 0.5.0 line");
